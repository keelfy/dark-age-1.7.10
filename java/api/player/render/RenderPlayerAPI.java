...
public final class RenderPlayerAPI {
	...
	private static void register(Class<?> baseClass, String id, RenderPlayerBaseSorting baseSorting) {
		if (!isCreated) {
			try {
				Method mandatory = net.minecraft.client.renderer.entity.RenderPlayer.class
						.getMethod("getRenderPlayerBase", String.class);
				if (mandatory.getReturnType() != RenderPlayerBase.class)
					throw new NoSuchMethodException(RenderPlayerBase.class.getName() + KString.SPACE
							+ net.minecraft.client.renderer.entity.RenderPlayer.class.getName()
							+ ".getRenderPlayerBase(" + String.class.getName() + ")");
				...
				for (int i = 0; i < errorMessageParts.length; i++)
					errorMessageParts[i] = MessageFormat.format(errorMessageParts[i], baseRenderPlayerClassName,
							targetClassName, targetClassFileName, stringClassName);
		...
		if (allreadyRegistered != null)
			throw new IllegalArgumentException(
					"The class '" + baseClass.getName() + "' can not be registered with the id '" + id
							+ "' because the class '" + allreadyRegistered.getDeclaringClass().getName()
		...
		try {
			...
			try {
				...
				throw new IllegalArgumentException("Can not find necessary constructor with one argument of type '"
						+ RenderPlayerAPI.class.getName()
						+ "' and eventually a second argument of type 'String' in the class '" + baseClass.getName()
						+ "'", t);
			}
		}
		...
		if (baseSorting != null) {
			...
			addSorting(id, allBaseBeforeDoRenderShadowAndFireSuperiors,
					baseSorting.getBeforeDoRenderShadowAndFireSuperiors());
			addSorting(id, allBaseBeforeDoRenderShadowAndFireInferiors,
					baseSorting.getBeforeDoRenderShadowAndFireInferiors());
			addSorting(id, allBaseOverrideDoRenderShadowAndFireSuperiors,
					baseSorting.getOverrideDoRenderShadowAndFireSuperiors());
			addSorting(id, allBaseOverrideDoRenderShadowAndFireInferiors,
					baseSorting.getOverrideDoRenderShadowAndFireInferiors());
			addSorting(id, allBaseAfterDoRenderShadowAndFireSuperiors,
					baseSorting.getAfterDoRenderShadowAndFireSuperiors());
			addSorting(id, allBaseAfterDoRenderShadowAndFireInferiors,
					baseSorting.getAfterDoRenderShadowAndFireInferiors());

			addSorting(id, allBaseBeforeGetColorMultiplierSuperiors,
					baseSorting.getBeforeGetColorMultiplierSuperiors());
			addSorting(id, allBaseBeforeGetColorMultiplierInferiors,
					baseSorting.getBeforeGetColorMultiplierInferiors());
			addSorting(id, allBaseOverrideGetColorMultiplierSuperiors,
					baseSorting.getOverrideGetColorMultiplierSuperiors());
			addSorting(id, allBaseOverrideGetColorMultiplierInferiors,
					baseSorting.getOverrideGetColorMultiplierInferiors());
			...
			addSorting(id, allBaseBeforeGetDeathMaxRotationSuperiors,
					baseSorting.getBeforeGetDeathMaxRotationSuperiors());
			addSorting(id, allBaseBeforeGetDeathMaxRotationInferiors,
					baseSorting.getBeforeGetDeathMaxRotationInferiors());
			addSorting(id, allBaseOverrideGetDeathMaxRotationSuperiors,
					baseSorting.getOverrideGetDeathMaxRotationSuperiors());
			addSorting(id, allBaseOverrideGetDeathMaxRotationInferiors,
					baseSorting.getOverrideGetDeathMaxRotationInferiors());
			addSorting(id, allBaseAfterGetDeathMaxRotationSuperiors,
					baseSorting.getAfterGetDeathMaxRotationSuperiors());
			addSorting(id, allBaseAfterGetDeathMaxRotationInferiors,
					baseSorting.getAfterGetDeathMaxRotationInferiors());

			addSorting(id, allBaseBeforeGetFontRendererFromRenderManagerSuperiors,
					baseSorting.getBeforeGetFontRendererFromRenderManagerSuperiors());
			addSorting(id, allBaseBeforeGetFontRendererFromRenderManagerInferiors,
					baseSorting.getBeforeGetFontRendererFromRenderManagerInferiors());
			addSorting(id, allBaseOverrideGetFontRendererFromRenderManagerSuperiors,
					baseSorting.getOverrideGetFontRendererFromRenderManagerSuperiors());
			addSorting(id, allBaseOverrideGetFontRendererFromRenderManagerInferiors,
					baseSorting.getOverrideGetFontRendererFromRenderManagerInferiors());
			addSorting(id, allBaseAfterGetFontRendererFromRenderManagerSuperiors,
					baseSorting.getAfterGetFontRendererFromRenderManagerSuperiors());
			addSorting(id, allBaseAfterGetFontRendererFromRenderManagerInferiors,
					baseSorting.getAfterGetFontRendererFromRenderManagerInferiors());

			addSorting(id, allBaseBeforeGetResourceLocationFromPlayerSuperiors,
					baseSorting.getBeforeGetResourceLocationFromPlayerSuperiors());
			addSorting(id, allBaseBeforeGetResourceLocationFromPlayerInferiors,
					baseSorting.getBeforeGetResourceLocationFromPlayerInferiors());
			addSorting(id, allBaseOverrideGetResourceLocationFromPlayerSuperiors,
					baseSorting.getOverrideGetResourceLocationFromPlayerSuperiors());
			addSorting(id, allBaseOverrideGetResourceLocationFromPlayerInferiors,
					baseSorting.getOverrideGetResourceLocationFromPlayerInferiors());
			addSorting(id, allBaseAfterGetResourceLocationFromPlayerSuperiors,
					baseSorting.getAfterGetResourceLocationFromPlayerSuperiors());
			addSorting(id, allBaseAfterGetResourceLocationFromPlayerInferiors,
					baseSorting.getAfterGetResourceLocationFromPlayerInferiors());

			addSorting(id, allBaseBeforeHandleRotationFloatSuperiors,
					baseSorting.getBeforeHandleRotationFloatSuperiors());
			addSorting(id, allBaseBeforeHandleRotationFloatInferiors,
					baseSorting.getBeforeHandleRotationFloatInferiors());
			addSorting(id, allBaseOverrideHandleRotationFloatSuperiors,
					baseSorting.getOverrideHandleRotationFloatSuperiors());
			addSorting(id, allBaseOverrideHandleRotationFloatInferiors,
					baseSorting.getOverrideHandleRotationFloatInferiors());
			addSorting(id, allBaseAfterHandleRotationFloatSuperiors,
					baseSorting.getAfterHandleRotationFloatSuperiors());
			addSorting(id, allBaseAfterHandleRotationFloatInferiors,
					baseSorting.getAfterHandleRotationFloatInferiors());
			...
			addSorting(id, allBaseOverrideInheritRenderPassSuperiors,
					baseSorting.getOverrideInheritRenderPassSuperiors());
			addSorting(id, allBaseOverrideInheritRenderPassInferiors,
					baseSorting.getOverrideInheritRenderPassInferiors());
			...
			addSorting(id, allBaseBeforeLoadTextureOfEntitySuperiors,
					baseSorting.getBeforeLoadTextureOfEntitySuperiors());
			addSorting(id, allBaseBeforeLoadTextureOfEntityInferiors,
					baseSorting.getBeforeLoadTextureOfEntityInferiors());
			addSorting(id, allBaseOverrideLoadTextureOfEntitySuperiors,
					baseSorting.getOverrideLoadTextureOfEntitySuperiors());
			addSorting(id, allBaseOverrideLoadTextureOfEntityInferiors,
					baseSorting.getOverrideLoadTextureOfEntityInferiors());
			addSorting(id, allBaseAfterLoadTextureOfEntitySuperiors,
					baseSorting.getAfterLoadTextureOfEntitySuperiors());
			addSorting(id, allBaseAfterLoadTextureOfEntityInferiors,
					baseSorting.getAfterLoadTextureOfEntityInferiors());
			...
			addSorting(id, allBaseOverridePassSpecialRenderSuperiors,
					baseSorting.getOverridePassSpecialRenderSuperiors());
			addSorting(id, allBaseOverridePassSpecialRenderInferiors,
					baseSorting.getOverridePassSpecialRenderInferiors());
			...
			addSorting(id, allBaseBeforePerformStaticEntityRebuildSuperiors,
					baseSorting.getBeforePerformStaticEntityRebuildSuperiors());
			addSorting(id, allBaseBeforePerformStaticEntityRebuildInferiors,
					baseSorting.getBeforePerformStaticEntityRebuildInferiors());
			addSorting(id, allBaseOverridePerformStaticEntityRebuildSuperiors,
					baseSorting.getOverridePerformStaticEntityRebuildSuperiors());
			addSorting(id, allBaseOverridePerformStaticEntityRebuildInferiors,
					baseSorting.getOverridePerformStaticEntityRebuildInferiors());
			addSorting(id, allBaseAfterPerformStaticEntityRebuildSuperiors,
					baseSorting.getAfterPerformStaticEntityRebuildSuperiors());
			addSorting(id, allBaseAfterPerformStaticEntityRebuildInferiors,
					baseSorting.getAfterPerformStaticEntityRebuildInferiors());

			addSorting(id, allBaseBeforeRenderArrowsStuckInEntitySuperiors,
					baseSorting.getBeforeRenderArrowsStuckInEntitySuperiors());
			addSorting(id, allBaseBeforeRenderArrowsStuckInEntityInferiors,
					baseSorting.getBeforeRenderArrowsStuckInEntityInferiors());
			addSorting(id, allBaseOverrideRenderArrowsStuckInEntitySuperiors,
					baseSorting.getOverrideRenderArrowsStuckInEntitySuperiors());
			addSorting(id, allBaseOverrideRenderArrowsStuckInEntityInferiors,
					baseSorting.getOverrideRenderArrowsStuckInEntityInferiors());
			addSorting(id, allBaseAfterRenderArrowsStuckInEntitySuperiors,
					baseSorting.getAfterRenderArrowsStuckInEntitySuperiors());
			addSorting(id, allBaseAfterRenderArrowsStuckInEntityInferiors,
					baseSorting.getAfterRenderArrowsStuckInEntityInferiors());

			addSorting(id, allBaseBeforeRenderFirstPersonArmSuperiors,
					baseSorting.getBeforeRenderFirstPersonArmSuperiors());
			addSorting(id, allBaseBeforeRenderFirstPersonArmInferiors,
					baseSorting.getBeforeRenderFirstPersonArmInferiors());
			addSorting(id, allBaseOverrideRenderFirstPersonArmSuperiors,
					baseSorting.getOverrideRenderFirstPersonArmSuperiors());
			addSorting(id, allBaseOverrideRenderFirstPersonArmInferiors,
					baseSorting.getOverrideRenderFirstPersonArmInferiors());
			addSorting(id, allBaseAfterRenderFirstPersonArmSuperiors,
					baseSorting.getAfterRenderFirstPersonArmSuperiors());
			addSorting(id, allBaseAfterRenderFirstPersonArmInferiors,
					baseSorting.getAfterRenderFirstPersonArmInferiors());
			...
			addSorting(id, allBaseOverrideRenderLivingLabelSuperiors,
					baseSorting.getOverrideRenderLivingLabelSuperiors());
			addSorting(id, allBaseOverrideRenderLivingLabelInferiors,
					baseSorting.getOverrideRenderLivingLabelInferiors());
			...
			addSorting(id, allBaseBeforeRenderPlayerNameAndScoreLabelSuperiors,
					baseSorting.getBeforeRenderPlayerNameAndScoreLabelSuperiors());
			addSorting(id, allBaseBeforeRenderPlayerNameAndScoreLabelInferiors,
					baseSorting.getBeforeRenderPlayerNameAndScoreLabelInferiors());
			addSorting(id, allBaseOverrideRenderPlayerNameAndScoreLabelSuperiors,
					baseSorting.getOverrideRenderPlayerNameAndScoreLabelSuperiors());
			addSorting(id, allBaseOverrideRenderPlayerNameAndScoreLabelInferiors,
					baseSorting.getOverrideRenderPlayerNameAndScoreLabelInferiors());
			addSorting(id, allBaseAfterRenderPlayerNameAndScoreLabelSuperiors,
					baseSorting.getAfterRenderPlayerNameAndScoreLabelSuperiors());
			addSorting(id, allBaseAfterRenderPlayerNameAndScoreLabelInferiors,
					baseSorting.getAfterRenderPlayerNameAndScoreLabelInferiors());
			...
			addSorting(id, allBaseOverrideRenderPlayerScaleSuperiors,
					baseSorting.getOverrideRenderPlayerScaleSuperiors());
			addSorting(id, allBaseOverrideRenderPlayerScaleInferiors,
					baseSorting.getOverrideRenderPlayerScaleInferiors());
			...
			addSorting(id, allBaseOverrideRenderPlayerSleepSuperiors,
					baseSorting.getOverrideRenderPlayerSleepSuperiors());
			addSorting(id, allBaseOverrideRenderPlayerSleepInferiors,
					baseSorting.getOverrideRenderPlayerSleepInferiors());
			...
			addSorting(id, allBaseBeforeRenderSwingProgressSuperiors,
					baseSorting.getBeforeRenderSwingProgressSuperiors());
			addSorting(id, allBaseBeforeRenderSwingProgressInferiors,
					baseSorting.getBeforeRenderSwingProgressInferiors());
			addSorting(id, allBaseOverrideRenderSwingProgressSuperiors,
					baseSorting.getOverrideRenderSwingProgressSuperiors());
			addSorting(id, allBaseOverrideRenderSwingProgressInferiors,
					baseSorting.getOverrideRenderSwingProgressInferiors());
			addSorting(id, allBaseAfterRenderSwingProgressSuperiors,
					baseSorting.getAfterRenderSwingProgressSuperiors());
			addSorting(id, allBaseAfterRenderSwingProgressInferiors,
					baseSorting.getAfterRenderSwingProgressInferiors());
			...
			addSorting(id, allBaseOverrideSetPassArmorModelSuperiors,
					baseSorting.getOverrideSetPassArmorModelSuperiors());
			addSorting(id, allBaseOverrideSetPassArmorModelInferiors,
					baseSorting.getOverrideSetPassArmorModelInferiors());
			...
			addSorting(id, allBaseOverrideSetRenderManagerSuperiors,
					baseSorting.getOverrideSetRenderManagerSuperiors());
			addSorting(id, allBaseOverrideSetRenderManagerInferiors,
					baseSorting.getOverrideSetRenderManagerInferiors());
			...
			addSorting(id, allBaseBeforeSetRenderPassModelSuperiors,
					baseSorting.getBeforeSetRenderPassModelSuperiors());
			addSorting(id, allBaseBeforeSetRenderPassModelInferiors,
					baseSorting.getBeforeSetRenderPassModelInferiors());
			addSorting(id, allBaseOverrideSetRenderPassModelSuperiors,
					baseSorting.getOverrideSetRenderPassModelSuperiors());
			addSorting(id, allBaseOverrideSetRenderPassModelInferiors,
					baseSorting.getOverrideSetRenderPassModelInferiors());
		...
		addMethod(id, baseClass, beforeDoRenderLabelHookTypes, "beforeDoRenderLabel",
				net.minecraft.entity.EntityLivingBase.class);
		addMethod(id, baseClass, overrideDoRenderLabelHookTypes, "doRenderLabel",
				net.minecraft.entity.EntityLivingBase.class);
		addMethod(id, baseClass, afterDoRenderLabelHookTypes, "afterDoRenderLabel",
				net.minecraft.entity.EntityLivingBase.class);

		addMethod(id, baseClass, beforeDoRenderShadowAndFireHookTypes, "beforeDoRenderShadowAndFire",
				net.minecraft.entity.Entity.class, double.class, double.class, double.class, float.class, float.class);
		addMethod(id, baseClass, overrideDoRenderShadowAndFireHookTypes, "doRenderShadowAndFire",
				net.minecraft.entity.Entity.class, double.class, double.class, double.class, float.class, float.class);
		addMethod(id, baseClass, afterDoRenderShadowAndFireHookTypes, "afterDoRenderShadowAndFire",
				net.minecraft.entity.Entity.class, double.class, double.class, double.class, float.class, float.class);

		addMethod(id, baseClass, beforeGetColorMultiplierHookTypes, "beforeGetColorMultiplier",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class);
		addMethod(id, baseClass, overrideGetColorMultiplierHookTypes, "getColorMultiplier",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class);
		addMethod(id, baseClass, afterGetColorMultiplierHookTypes, "afterGetColorMultiplier",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class);

		addMethod(id, baseClass, beforeGetDeathMaxRotationHookTypes, "beforeGetDeathMaxRotation",
				net.minecraft.entity.EntityLivingBase.class);
		addMethod(id, baseClass, overrideGetDeathMaxRotationHookTypes, "getDeathMaxRotation",
				net.minecraft.entity.EntityLivingBase.class);
		addMethod(id, baseClass, afterGetDeathMaxRotationHookTypes, "afterGetDeathMaxRotation",
				net.minecraft.entity.EntityLivingBase.class);

		addMethod(id, baseClass, beforeGetFontRendererFromRenderManagerHookTypes,
				"beforeGetFontRendererFromRenderManager");
		addMethod(id, baseClass, overrideGetFontRendererFromRenderManagerHookTypes, "getFontRendererFromRenderManager");
		addMethod(id, baseClass, afterGetFontRendererFromRenderManagerHookTypes,
				"afterGetFontRendererFromRenderManager");

		addMethod(id, baseClass, beforeGetResourceLocationFromPlayerHookTypes, "beforeGetResourceLocationFromPlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class);
		addMethod(id, baseClass, overrideGetResourceLocationFromPlayerHookTypes, "getResourceLocationFromPlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class);
		addMethod(id, baseClass, afterGetResourceLocationFromPlayerHookTypes, "afterGetResourceLocationFromPlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class);

		addMethod(id, baseClass, beforeHandleRotationFloatHookTypes, "beforeHandleRotationFloat",
				net.minecraft.entity.EntityLivingBase.class, float.class);
		addMethod(id, baseClass, overrideHandleRotationFloatHookTypes, "handleRotationFloat",
				net.minecraft.entity.EntityLivingBase.class, float.class);
		addMethod(id, baseClass, afterHandleRotationFloatHookTypes, "afterHandleRotationFloat",
				net.minecraft.entity.EntityLivingBase.class, float.class);

		addMethod(id, baseClass, beforeInheritRenderPassHookTypes, "beforeInheritRenderPass",
				net.minecraft.entity.EntityLivingBase.class, int.class, float.class);
		addMethod(id, baseClass, overrideInheritRenderPassHookTypes, "inheritRenderPass",
				net.minecraft.entity.EntityLivingBase.class, int.class, float.class);
		addMethod(id, baseClass, afterInheritRenderPassHookTypes, "afterInheritRenderPass",
				net.minecraft.entity.EntityLivingBase.class, int.class, float.class);

		addMethod(id, baseClass, beforeLoadTextureHookTypes, "beforeLoadTexture",
				net.minecraft.util.ResourceLocation.class);
		addMethod(id, baseClass, overrideLoadTextureHookTypes, "loadTexture",
				net.minecraft.util.ResourceLocation.class);
		addMethod(id, baseClass, afterLoadTextureHookTypes, "afterLoadTexture",
				net.minecraft.util.ResourceLocation.class);

		addMethod(id, baseClass, beforeLoadTextureOfEntityHookTypes, "beforeLoadTextureOfEntity",
				net.minecraft.entity.Entity.class);
		addMethod(id, baseClass, overrideLoadTextureOfEntityHookTypes, "loadTextureOfEntity",
				net.minecraft.entity.Entity.class);
		addMethod(id, baseClass, afterLoadTextureOfEntityHookTypes, "afterLoadTextureOfEntity",
				net.minecraft.entity.Entity.class);

		addMethod(id, baseClass, beforePassSpecialRenderHookTypes, "beforePassSpecialRender",
				net.minecraft.entity.EntityLivingBase.class, double.class, double.class, double.class);
		addMethod(id, baseClass, overridePassSpecialRenderHookTypes, "passSpecialRender",
				net.minecraft.entity.EntityLivingBase.class, double.class, double.class, double.class);
		addMethod(id, baseClass, afterPassSpecialRenderHookTypes, "afterPassSpecialRender",
				net.minecraft.entity.EntityLivingBase.class, double.class, double.class, double.class);
		...
		addMethod(id, baseClass, beforeRenderArrowsStuckInEntityHookTypes, "beforeRenderArrowsStuckInEntity",
				net.minecraft.entity.EntityLivingBase.class, float.class);
		addMethod(id, baseClass, overrideRenderArrowsStuckInEntityHookTypes, "renderArrowsStuckInEntity",
				net.minecraft.entity.EntityLivingBase.class, float.class);
		addMethod(id, baseClass, afterRenderArrowsStuckInEntityHookTypes, "afterRenderArrowsStuckInEntity",
				net.minecraft.entity.EntityLivingBase.class, float.class);

		addMethod(id, baseClass, beforeRenderFirstPersonArmHookTypes, "beforeRenderFirstPersonArm",
				net.minecraft.entity.player.EntityPlayer.class);
		addMethod(id, baseClass, overrideRenderFirstPersonArmHookTypes, "renderFirstPersonArm",
				net.minecraft.entity.player.EntityPlayer.class);
		addMethod(id, baseClass, afterRenderFirstPersonArmHookTypes, "afterRenderFirstPersonArm",
				net.minecraft.entity.player.EntityPlayer.class);

		addMethod(id, baseClass, beforeRenderLivingLabelHookTypes, "beforeRenderLivingLabel",
				net.minecraft.entity.Entity.class, String.class, double.class, double.class, double.class, int.class);
		addMethod(id, baseClass, overrideRenderLivingLabelHookTypes, "renderLivingLabel",
				net.minecraft.entity.Entity.class, String.class, double.class, double.class, double.class, int.class);
		addMethod(id, baseClass, afterRenderLivingLabelHookTypes, "afterRenderLivingLabel",
				net.minecraft.entity.Entity.class, String.class, double.class, double.class, double.class, int.class);

		addMethod(id, baseClass, beforeRenderModelHookTypes, "beforeRenderModel",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class, float.class, float.class,
				float.class, float.class);
		addMethod(id, baseClass, overrideRenderModelHookTypes, "renderModel",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class, float.class, float.class,
				float.class, float.class);
		addMethod(id, baseClass, afterRenderModelHookTypes, "afterRenderModel",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class, float.class, float.class,
				float.class, float.class);

		addMethod(id, baseClass, beforeRenderPlayerHookTypes, "beforeRenderPlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class,
				float.class, float.class);
		addMethod(id, baseClass, overrideRenderPlayerHookTypes, "renderPlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class,
				float.class, float.class);
		addMethod(id, baseClass, afterRenderPlayerHookTypes, "afterRenderPlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class,
				float.class, float.class);

		addMethod(id, baseClass, beforeRenderPlayerNameAndScoreLabelHookTypes, "beforeRenderPlayerNameAndScoreLabel",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class,
				String.class, float.class, double.class);
		addMethod(id, baseClass, overrideRenderPlayerNameAndScoreLabelHookTypes, "renderPlayerNameAndScoreLabel",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class,
				String.class, float.class, double.class);
		addMethod(id, baseClass, afterRenderPlayerNameAndScoreLabelHookTypes, "afterRenderPlayerNameAndScoreLabel",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class,
				String.class, float.class, double.class);

		addMethod(id, baseClass, beforeRenderPlayerScaleHookTypes, "beforeRenderPlayerScale",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class);
		addMethod(id, baseClass, overrideRenderPlayerScaleHookTypes, "renderPlayerScale",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class);
		addMethod(id, baseClass, afterRenderPlayerScaleHookTypes, "afterRenderPlayerScale",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class);

		addMethod(id, baseClass, beforeRenderPlayerSleepHookTypes, "beforeRenderPlayerSleep",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class);
		addMethod(id, baseClass, overrideRenderPlayerSleepHookTypes, "renderPlayerSleep",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class);
		addMethod(id, baseClass, afterRenderPlayerSleepHookTypes, "afterRenderPlayerSleep",
				net.minecraft.client.entity.AbstractClientPlayer.class, double.class, double.class, double.class);

		addMethod(id, baseClass, beforeRenderSpecialsHookTypes, "beforeRenderSpecials",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class);
		addMethod(id, baseClass, overrideRenderSpecialsHookTypes, "renderSpecials",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class);
		addMethod(id, baseClass, afterRenderSpecialsHookTypes, "afterRenderSpecials",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class);

		addMethod(id, baseClass, beforeRenderSwingProgressHookTypes, "beforeRenderSwingProgress",
				net.minecraft.entity.EntityLivingBase.class, float.class);
		addMethod(id, baseClass, overrideRenderSwingProgressHookTypes, "renderSwingProgress",
				net.minecraft.entity.EntityLivingBase.class, float.class);
		addMethod(id, baseClass, afterRenderSwingProgressHookTypes, "afterRenderSwingProgress",
				net.minecraft.entity.EntityLivingBase.class, float.class);

		addMethod(id, baseClass, beforeRotatePlayerHookTypes, "beforeRotatePlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class, float.class, float.class);
		addMethod(id, baseClass, overrideRotatePlayerHookTypes, "rotatePlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class, float.class, float.class);
		addMethod(id, baseClass, afterRotatePlayerHookTypes, "afterRotatePlayer",
				net.minecraft.client.entity.AbstractClientPlayer.class, float.class, float.class, float.class);

		addMethod(id, baseClass, beforeSetArmorModelHookTypes, "beforeSetArmorModel",
				net.minecraft.client.entity.AbstractClientPlayer.class, int.class, float.class);
		addMethod(id, baseClass, overrideSetArmorModelHookTypes, "setArmorModel",
				net.minecraft.client.entity.AbstractClientPlayer.class, int.class, float.class);
		addMethod(id, baseClass, afterSetArmorModelHookTypes, "afterSetArmorModel",
				net.minecraft.client.entity.AbstractClientPlayer.class, int.class, float.class);

		addMethod(id, baseClass, beforeSetPassArmorModelHookTypes, "beforeSetPassArmorModel",
				net.minecraft.client.entity.AbstractClientPlayer.class, int.class, float.class);
		addMethod(id, baseClass, overrideSetPassArmorModelHookTypes, "setPassArmorModel",
				net.minecraft.client.entity.AbstractClientPlayer.class, int.class, float.class);
		addMethod(id, baseClass, afterSetPassArmorModelHookTypes, "afterSetPassArmorModel",
				net.minecraft.client.entity.AbstractClientPlayer.class, int.class, float.class);

		addMethod(id, baseClass, beforeSetRenderManagerHookTypes, "beforeSetRenderManager",
				net.minecraft.client.renderer.entity.RenderManager.class);
		addMethod(id, baseClass, overrideSetRenderManagerHookTypes, "setRenderManager",
				net.minecraft.client.renderer.entity.RenderManager.class);
		addMethod(id, baseClass, afterSetRenderManagerHookTypes, "afterSetRenderManager",
				net.minecraft.client.renderer.entity.RenderManager.class);

		addMethod(id, baseClass, beforeSetRenderPassModelHookTypes, "beforeSetRenderPassModel",
				net.minecraft.client.model.ModelBase.class);
		addMethod(id, baseClass, overrideSetRenderPassModelHookTypes, "setRenderPassModel",
				net.minecraft.client.model.ModelBase.class);
		addMethod(id, baseClass, afterSetRenderPassModelHookTypes, "afterSetRenderPassModel",
				net.minecraft.client.model.ModelBase.class);

		addMethod(id, baseClass, beforeUpdateIconsHookTypes, "beforeUpdateIcons",
				net.minecraft.client.renderer.texture.IIconRegister.class);
		addMethod(id, baseClass, overrideUpdateIconsHookTypes, "updateIcons",
				net.minecraft.client.renderer.texture.IIconRegister.class);
		addMethod(id, baseClass, afterUpdateIconsHookTypes, "afterUpdateIcons",
				net.minecraft.client.renderer.texture.IIconRegister.class);
	...
	private static void initialize() {
		sortBases(beforeLocalConstructingHookTypes, allBaseBeforeLocalConstructingSuperiors,
				allBaseBeforeLocalConstructingInferiors, "beforeLocalConstructing");
		sortBases(afterLocalConstructingHookTypes, allBaseAfterLocalConstructingSuperiors,
				allBaseAfterLocalConstructingInferiors, "afterLocalConstructing");
		...
		while (keyIterator.hasNext()) {
			...
			sortDynamicBases(overrideDynamicHookTypes, allBaseOverrideDynamicSuperiors, allBaseOverrideDynamicInferiors,
					key);
			sortDynamicBases(afterDynamicHookTypes, allBaseAfterDynamicSuperiors, allBaseAfterDynamicInferiors, key);
		}

		sortBases(beforeDoRenderLabelHookTypes, allBaseBeforeDoRenderLabelSuperiors,
				allBaseBeforeDoRenderLabelInferiors, "beforeDoRenderLabel");
		sortBases(overrideDoRenderLabelHookTypes, allBaseOverrideDoRenderLabelSuperiors,
				allBaseOverrideDoRenderLabelInferiors, "overrideDoRenderLabel");
		sortBases(afterDoRenderLabelHookTypes, allBaseAfterDoRenderLabelSuperiors, allBaseAfterDoRenderLabelInferiors,
				"afterDoRenderLabel");

		sortBases(beforeDoRenderShadowAndFireHookTypes, allBaseBeforeDoRenderShadowAndFireSuperiors,
				allBaseBeforeDoRenderShadowAndFireInferiors, "beforeDoRenderShadowAndFire");
		sortBases(overrideDoRenderShadowAndFireHookTypes, allBaseOverrideDoRenderShadowAndFireSuperiors,
				allBaseOverrideDoRenderShadowAndFireInferiors, "overrideDoRenderShadowAndFire");
		sortBases(afterDoRenderShadowAndFireHookTypes, allBaseAfterDoRenderShadowAndFireSuperiors,
				allBaseAfterDoRenderShadowAndFireInferiors, "afterDoRenderShadowAndFire");

		sortBases(beforeGetColorMultiplierHookTypes, allBaseBeforeGetColorMultiplierSuperiors,
				allBaseBeforeGetColorMultiplierInferiors, "beforeGetColorMultiplier");
		sortBases(overrideGetColorMultiplierHookTypes, allBaseOverrideGetColorMultiplierSuperiors,
				allBaseOverrideGetColorMultiplierInferiors, "overrideGetColorMultiplier");
		sortBases(afterGetColorMultiplierHookTypes, allBaseAfterGetColorMultiplierSuperiors,
				allBaseAfterGetColorMultiplierInferiors, "afterGetColorMultiplier");

		sortBases(beforeGetDeathMaxRotationHookTypes, allBaseBeforeGetDeathMaxRotationSuperiors,
				allBaseBeforeGetDeathMaxRotationInferiors, "beforeGetDeathMaxRotation");
		sortBases(overrideGetDeathMaxRotationHookTypes, allBaseOverrideGetDeathMaxRotationSuperiors,
				allBaseOverrideGetDeathMaxRotationInferiors, "overrideGetDeathMaxRotation");
		sortBases(afterGetDeathMaxRotationHookTypes, allBaseAfterGetDeathMaxRotationSuperiors,
				allBaseAfterGetDeathMaxRotationInferiors, "afterGetDeathMaxRotation");

		sortBases(beforeGetFontRendererFromRenderManagerHookTypes,
				allBaseBeforeGetFontRendererFromRenderManagerSuperiors,
				allBaseBeforeGetFontRendererFromRenderManagerInferiors, "beforeGetFontRendererFromRenderManager");
		sortBases(overrideGetFontRendererFromRenderManagerHookTypes,
				allBaseOverrideGetFontRendererFromRenderManagerSuperiors,
				allBaseOverrideGetFontRendererFromRenderManagerInferiors, "overrideGetFontRendererFromRenderManager");
		sortBases(afterGetFontRendererFromRenderManagerHookTypes, allBaseAfterGetFontRendererFromRenderManagerSuperiors,
				allBaseAfterGetFontRendererFromRenderManagerInferiors, "afterGetFontRendererFromRenderManager");

		sortBases(beforeGetResourceLocationFromPlayerHookTypes, allBaseBeforeGetResourceLocationFromPlayerSuperiors,
				allBaseBeforeGetResourceLocationFromPlayerInferiors, "beforeGetResourceLocationFromPlayer");
		sortBases(overrideGetResourceLocationFromPlayerHookTypes, allBaseOverrideGetResourceLocationFromPlayerSuperiors,
				allBaseOverrideGetResourceLocationFromPlayerInferiors, "overrideGetResourceLocationFromPlayer");
		sortBases(afterGetResourceLocationFromPlayerHookTypes, allBaseAfterGetResourceLocationFromPlayerSuperiors,
				allBaseAfterGetResourceLocationFromPlayerInferiors, "afterGetResourceLocationFromPlayer");

		sortBases(beforeHandleRotationFloatHookTypes, allBaseBeforeHandleRotationFloatSuperiors,
				allBaseBeforeHandleRotationFloatInferiors, "beforeHandleRotationFloat");
		sortBases(overrideHandleRotationFloatHookTypes, allBaseOverrideHandleRotationFloatSuperiors,
				allBaseOverrideHandleRotationFloatInferiors, "overrideHandleRotationFloat");
		sortBases(afterHandleRotationFloatHookTypes, allBaseAfterHandleRotationFloatSuperiors,
				allBaseAfterHandleRotationFloatInferiors, "afterHandleRotationFloat");

		sortBases(beforeInheritRenderPassHookTypes, allBaseBeforeInheritRenderPassSuperiors,
				allBaseBeforeInheritRenderPassInferiors, "beforeInheritRenderPass");
		sortBases(overrideInheritRenderPassHookTypes, allBaseOverrideInheritRenderPassSuperiors,
				allBaseOverrideInheritRenderPassInferiors, "overrideInheritRenderPass");
		sortBases(afterInheritRenderPassHookTypes, allBaseAfterInheritRenderPassSuperiors,
				allBaseAfterInheritRenderPassInferiors, "afterInheritRenderPass");

		sortBases(beforeLoadTextureHookTypes, allBaseBeforeLoadTextureSuperiors, allBaseBeforeLoadTextureInferiors,
				"beforeLoadTexture");
		sortBases(overrideLoadTextureHookTypes, allBaseOverrideLoadTextureSuperiors,
				allBaseOverrideLoadTextureInferiors, "overrideLoadTexture");
		sortBases(afterLoadTextureHookTypes, allBaseAfterLoadTextureSuperiors, allBaseAfterLoadTextureInferiors,
				"afterLoadTexture");

		sortBases(beforeLoadTextureOfEntityHookTypes, allBaseBeforeLoadTextureOfEntitySuperiors,
				allBaseBeforeLoadTextureOfEntityInferiors, "beforeLoadTextureOfEntity");
		sortBases(overrideLoadTextureOfEntityHookTypes, allBaseOverrideLoadTextureOfEntitySuperiors,
				allBaseOverrideLoadTextureOfEntityInferiors, "overrideLoadTextureOfEntity");
		sortBases(afterLoadTextureOfEntityHookTypes, allBaseAfterLoadTextureOfEntitySuperiors,
				allBaseAfterLoadTextureOfEntityInferiors, "afterLoadTextureOfEntity");

		sortBases(beforePassSpecialRenderHookTypes, allBaseBeforePassSpecialRenderSuperiors,
				allBaseBeforePassSpecialRenderInferiors, "beforePassSpecialRender");
		sortBases(overridePassSpecialRenderHookTypes, allBaseOverridePassSpecialRenderSuperiors,
				allBaseOverridePassSpecialRenderInferiors, "overridePassSpecialRender");
		sortBases(afterPassSpecialRenderHookTypes, allBaseAfterPassSpecialRenderSuperiors,
				allBaseAfterPassSpecialRenderInferiors, "afterPassSpecialRender");

		sortBases(beforePerformStaticEntityRebuildHookTypes, allBaseBeforePerformStaticEntityRebuildSuperiors,
				allBaseBeforePerformStaticEntityRebuildInferiors, "beforePerformStaticEntityRebuild");
		sortBases(overridePerformStaticEntityRebuildHookTypes, allBaseOverridePerformStaticEntityRebuildSuperiors,
				allBaseOverridePerformStaticEntityRebuildInferiors, "overridePerformStaticEntityRebuild");
		sortBases(afterPerformStaticEntityRebuildHookTypes, allBaseAfterPerformStaticEntityRebuildSuperiors,
				allBaseAfterPerformStaticEntityRebuildInferiors, "afterPerformStaticEntityRebuild");

		sortBases(beforeRenderArrowsStuckInEntityHookTypes, allBaseBeforeRenderArrowsStuckInEntitySuperiors,
				allBaseBeforeRenderArrowsStuckInEntityInferiors, "beforeRenderArrowsStuckInEntity");
		sortBases(overrideRenderArrowsStuckInEntityHookTypes, allBaseOverrideRenderArrowsStuckInEntitySuperiors,
				allBaseOverrideRenderArrowsStuckInEntityInferiors, "overrideRenderArrowsStuckInEntity");
		sortBases(afterRenderArrowsStuckInEntityHookTypes, allBaseAfterRenderArrowsStuckInEntitySuperiors,
				allBaseAfterRenderArrowsStuckInEntityInferiors, "afterRenderArrowsStuckInEntity");

		sortBases(beforeRenderFirstPersonArmHookTypes, allBaseBeforeRenderFirstPersonArmSuperiors,
				allBaseBeforeRenderFirstPersonArmInferiors, "beforeRenderFirstPersonArm");
		sortBases(overrideRenderFirstPersonArmHookTypes, allBaseOverrideRenderFirstPersonArmSuperiors,
				allBaseOverrideRenderFirstPersonArmInferiors, "overrideRenderFirstPersonArm");
		sortBases(afterRenderFirstPersonArmHookTypes, allBaseAfterRenderFirstPersonArmSuperiors,
				allBaseAfterRenderFirstPersonArmInferiors, "afterRenderFirstPersonArm");

		sortBases(beforeRenderLivingLabelHookTypes, allBaseBeforeRenderLivingLabelSuperiors,
				allBaseBeforeRenderLivingLabelInferiors, "beforeRenderLivingLabel");
		sortBases(overrideRenderLivingLabelHookTypes, allBaseOverrideRenderLivingLabelSuperiors,
				allBaseOverrideRenderLivingLabelInferiors, "overrideRenderLivingLabel");
		sortBases(afterRenderLivingLabelHookTypes, allBaseAfterRenderLivingLabelSuperiors,
				allBaseAfterRenderLivingLabelInferiors, "afterRenderLivingLabel");

		sortBases(beforeRenderModelHookTypes, allBaseBeforeRenderModelSuperiors, allBaseBeforeRenderModelInferiors,
				"beforeRenderModel");
		sortBases(overrideRenderModelHookTypes, allBaseOverrideRenderModelSuperiors,
				allBaseOverrideRenderModelInferiors, "overrideRenderModel");
		sortBases(afterRenderModelHookTypes, allBaseAfterRenderModelSuperiors, allBaseAfterRenderModelInferiors,
				"afterRenderModel");

		sortBases(beforeRenderPlayerHookTypes, allBaseBeforeRenderPlayerSuperiors, allBaseBeforeRenderPlayerInferiors,
				"beforeRenderPlayer");
		sortBases(overrideRenderPlayerHookTypes, allBaseOverrideRenderPlayerSuperiors,
				allBaseOverrideRenderPlayerInferiors, "overrideRenderPlayer");
		sortBases(afterRenderPlayerHookTypes, allBaseAfterRenderPlayerSuperiors, allBaseAfterRenderPlayerInferiors,
				"afterRenderPlayer");

		sortBases(beforeRenderPlayerNameAndScoreLabelHookTypes, allBaseBeforeRenderPlayerNameAndScoreLabelSuperiors,
				allBaseBeforeRenderPlayerNameAndScoreLabelInferiors, "beforeRenderPlayerNameAndScoreLabel");
		sortBases(overrideRenderPlayerNameAndScoreLabelHookTypes, allBaseOverrideRenderPlayerNameAndScoreLabelSuperiors,
				allBaseOverrideRenderPlayerNameAndScoreLabelInferiors, "overrideRenderPlayerNameAndScoreLabel");
		sortBases(afterRenderPlayerNameAndScoreLabelHookTypes, allBaseAfterRenderPlayerNameAndScoreLabelSuperiors,
				allBaseAfterRenderPlayerNameAndScoreLabelInferiors, "afterRenderPlayerNameAndScoreLabel");

		sortBases(beforeRenderPlayerScaleHookTypes, allBaseBeforeRenderPlayerScaleSuperiors,
				allBaseBeforeRenderPlayerScaleInferiors, "beforeRenderPlayerScale");
		sortBases(overrideRenderPlayerScaleHookTypes, allBaseOverrideRenderPlayerScaleSuperiors,
				allBaseOverrideRenderPlayerScaleInferiors, "overrideRenderPlayerScale");
		sortBases(afterRenderPlayerScaleHookTypes, allBaseAfterRenderPlayerScaleSuperiors,
				allBaseAfterRenderPlayerScaleInferiors, "afterRenderPlayerScale");

		sortBases(beforeRenderPlayerSleepHookTypes, allBaseBeforeRenderPlayerSleepSuperiors,
				allBaseBeforeRenderPlayerSleepInferiors, "beforeRenderPlayerSleep");
		sortBases(overrideRenderPlayerSleepHookTypes, allBaseOverrideRenderPlayerSleepSuperiors,
				allBaseOverrideRenderPlayerSleepInferiors, "overrideRenderPlayerSleep");
		sortBases(afterRenderPlayerSleepHookTypes, allBaseAfterRenderPlayerSleepSuperiors,
				allBaseAfterRenderPlayerSleepInferiors, "afterRenderPlayerSleep");

		sortBases(beforeRenderSpecialsHookTypes, allBaseBeforeRenderSpecialsSuperiors,
				allBaseBeforeRenderSpecialsInferiors, "beforeRenderSpecials");
		sortBases(overrideRenderSpecialsHookTypes, allBaseOverrideRenderSpecialsSuperiors,
				allBaseOverrideRenderSpecialsInferiors, "overrideRenderSpecials");
		sortBases(afterRenderSpecialsHookTypes, allBaseAfterRenderSpecialsSuperiors,
				allBaseAfterRenderSpecialsInferiors, "afterRenderSpecials");

		sortBases(beforeRenderSwingProgressHookTypes, allBaseBeforeRenderSwingProgressSuperiors,
				allBaseBeforeRenderSwingProgressInferiors, "beforeRenderSwingProgress");
		sortBases(overrideRenderSwingProgressHookTypes, allBaseOverrideRenderSwingProgressSuperiors,
				allBaseOverrideRenderSwingProgressInferiors, "overrideRenderSwingProgress");
		sortBases(afterRenderSwingProgressHookTypes, allBaseAfterRenderSwingProgressSuperiors,
				allBaseAfterRenderSwingProgressInferiors, "afterRenderSwingProgress");

		sortBases(beforeRotatePlayerHookTypes, allBaseBeforeRotatePlayerSuperiors, allBaseBeforeRotatePlayerInferiors,
				"beforeRotatePlayer");
		sortBases(overrideRotatePlayerHookTypes, allBaseOverrideRotatePlayerSuperiors,
				allBaseOverrideRotatePlayerInferiors, "overrideRotatePlayer");
		sortBases(afterRotatePlayerHookTypes, allBaseAfterRotatePlayerSuperiors, allBaseAfterRotatePlayerInferiors,
				"afterRotatePlayer");

		sortBases(beforeSetArmorModelHookTypes, allBaseBeforeSetArmorModelSuperiors,
				allBaseBeforeSetArmorModelInferiors, "beforeSetArmorModel");
		sortBases(overrideSetArmorModelHookTypes, allBaseOverrideSetArmorModelSuperiors,
				allBaseOverrideSetArmorModelInferiors, "overrideSetArmorModel");
		sortBases(afterSetArmorModelHookTypes, allBaseAfterSetArmorModelSuperiors, allBaseAfterSetArmorModelInferiors,
				"afterSetArmorModel");

		sortBases(beforeSetPassArmorModelHookTypes, allBaseBeforeSetPassArmorModelSuperiors,
				allBaseBeforeSetPassArmorModelInferiors, "beforeSetPassArmorModel");
		sortBases(overrideSetPassArmorModelHookTypes, allBaseOverrideSetPassArmorModelSuperiors,
				allBaseOverrideSetPassArmorModelInferiors, "overrideSetPassArmorModel");
		sortBases(afterSetPassArmorModelHookTypes, allBaseAfterSetPassArmorModelSuperiors,
				allBaseAfterSetPassArmorModelInferiors, "afterSetPassArmorModel");

		sortBases(beforeSetRenderManagerHookTypes, allBaseBeforeSetRenderManagerSuperiors,
				allBaseBeforeSetRenderManagerInferiors, "beforeSetRenderManager");
		sortBases(overrideSetRenderManagerHookTypes, allBaseOverrideSetRenderManagerSuperiors,
				allBaseOverrideSetRenderManagerInferiors, "overrideSetRenderManager");
		sortBases(afterSetRenderManagerHookTypes, allBaseAfterSetRenderManagerSuperiors,
				allBaseAfterSetRenderManagerInferiors, "afterSetRenderManager");

		sortBases(beforeSetRenderPassModelHookTypes, allBaseBeforeSetRenderPassModelSuperiors,
				allBaseBeforeSetRenderPassModelInferiors, "beforeSetRenderPassModel");
		sortBases(overrideSetRenderPassModelHookTypes, allBaseOverrideSetRenderPassModelSuperiors,
				allBaseOverrideSetRenderPassModelInferiors, "overrideSetRenderPassModel");
		sortBases(afterSetRenderPassModelHookTypes, allBaseAfterSetRenderPassModelSuperiors,
				allBaseAfterSetRenderPassModelInferiors, "afterSetRenderPassModel");

		sortBases(beforeUpdateIconsHookTypes, allBaseBeforeUpdateIconsSuperiors, allBaseBeforeUpdateIconsInferiors,
				"beforeUpdateIcons");
		sortBases(overrideUpdateIconsHookTypes, allBaseOverrideUpdateIconsSuperiors,
				allBaseOverrideUpdateIconsInferiors, "overrideUpdateIcons");
		sortBases(afterUpdateIconsHookTypes, allBaseAfterUpdateIconsSuperiors, allBaseAfterUpdateIconsInferiors,
				"afterUpdateIcons");
	...
	private final static Map<String, String[]> EmptySortMap = Collections
	...
	private static void sortDynamicBases(Map<String, List<String>> lists,
		...
		if (types != null && types.size() > 1)
			sortBases(types, getDynamicSorters(key, types, allBaseSuperiors),
					getDynamicSorters(key, types, allBaseInferiors), key);
	}
	...
	private RenderPlayerBase createRenderPlayerBase(String id) {
		...
		try {
			...
			throw new RuntimeException(
					"Exception while creating a RenderPlayerBase of type '" + contructor.getDeclaringClass() + "'", e);
		}
		return base;
	}
	...
	private void updateRenderPlayerBases() {
		...
		isDoRenderLabelModded = beforeDoRenderLabelHooks != null || overrideDoRenderLabelHooks != null
		...
		isDoRenderShadowAndFireModded = beforeDoRenderShadowAndFireHooks != null
				|| overrideDoRenderShadowAndFireHooks != null || afterDoRenderShadowAndFireHooks != null;
		...
		isGetColorMultiplierModded = beforeGetColorMultiplierHooks != null || overrideGetColorMultiplierHooks != null
		...
		isGetDeathMaxRotationModded = beforeGetDeathMaxRotationHooks != null || overrideGetDeathMaxRotationHooks != null
		...
		isGetFontRendererFromRenderManagerModded = beforeGetFontRendererFromRenderManagerHooks != null
		...
		isGetResourceLocationFromPlayerModded = beforeGetResourceLocationFromPlayerHooks != null
		...
		isHandleRotationFloatModded = beforeHandleRotationFloatHooks != null || overrideHandleRotationFloatHooks != null
		...
		isInheritRenderPassModded = beforeInheritRenderPassHooks != null || overrideInheritRenderPassHooks != null
		...
		isLoadTextureModded = beforeLoadTextureHooks != null || overrideLoadTextureHooks != null
		...
		isLoadTextureOfEntityModded = beforeLoadTextureOfEntityHooks != null || overrideLoadTextureOfEntityHooks != null
		...
		isPassSpecialRenderModded = beforePassSpecialRenderHooks != null || overridePassSpecialRenderHooks != null
		...
		isPerformStaticEntityRebuildModded = beforePerformStaticEntityRebuildHooks != null
				|| overridePerformStaticEntityRebuildHooks != null || afterPerformStaticEntityRebuildHooks != null;
		...
		isRenderArrowsStuckInEntityModded = beforeRenderArrowsStuckInEntityHooks != null
				|| overrideRenderArrowsStuckInEntityHooks != null || afterRenderArrowsStuckInEntityHooks != null;
		...
		isRenderFirstPersonArmModded = beforeRenderFirstPersonArmHooks != null
				|| overrideRenderFirstPersonArmHooks != null || afterRenderFirstPersonArmHooks != null;
		...
		isRenderLivingLabelModded = beforeRenderLivingLabelHooks != null || overrideRenderLivingLabelHooks != null
		...
		isRenderModelModded = beforeRenderModelHooks != null || overrideRenderModelHooks != null
		...
		isRenderPlayerModded = beforeRenderPlayerHooks != null || overrideRenderPlayerHooks != null
		...
		isRenderPlayerNameAndScoreLabelModded = beforeRenderPlayerNameAndScoreLabelHooks != null
		...
		isRenderPlayerScaleModded = beforeRenderPlayerScaleHooks != null || overrideRenderPlayerScaleHooks != null
		...
		isRenderPlayerSleepModded = beforeRenderPlayerSleepHooks != null || overrideRenderPlayerSleepHooks != null
		...
		isRenderSpecialsModded = beforeRenderSpecialsHooks != null || overrideRenderSpecialsHooks != null
		...
		isRenderSwingProgressModded = beforeRenderSwingProgressHooks != null || overrideRenderSwingProgressHooks != null
		...
		isRotatePlayerModded = beforeRotatePlayerHooks != null || overrideRotatePlayerHooks != null
		...
		isSetArmorModelModded = beforeSetArmorModelHooks != null || overrideSetArmorModelHooks != null
		...
		isSetPassArmorModelModded = beforeSetPassArmorModelHooks != null || overrideSetPassArmorModelHooks != null
		...
		isSetRenderManagerModded = beforeSetRenderManagerHooks != null || overrideSetRenderManagerHooks != null
		...
		isSetRenderPassModelModded = beforeSetRenderPassModelHooks != null || overrideSetRenderPassModelHooks != null
		...
		isUpdateIconsModded = beforeUpdateIconsHooks != null || overrideUpdateIconsHooks != null
	...
	public static boolean doRenderLabel(IRenderPlayerAPI target,
	...
	private boolean doRenderLabel(net.minecraft.entity.EntityLivingBase paramEntityLivingBase) {
		...
		if (overrideDoRenderLabelHooks != null)
			_result = overrideDoRenderLabelHooks[overrideDoRenderLabelHooks.length - 1]
					.doRenderLabel(paramEntityLivingBase);
		else
	...
	private static final Map<String, String[]> allBaseOverrideDoRenderLabelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideDoRenderLabelInferiors = new Hashtable<String, String[]>(
			0);
	...
	public static void doRenderShadowAndFire(IRenderPlayerAPI target, net.minecraft.entity.Entity paramEntity,
		...
		if (renderPlayerAPI != null && renderPlayerAPI.isDoRenderShadowAndFireModded)
			renderPlayerAPI.doRenderShadowAndFire(paramEntity, paramDouble1, paramDouble2, paramDouble3, paramFloat1,
					paramFloat2);
		else
			target.localDoRenderShadowAndFire(paramEntity, paramDouble1, paramDouble2, paramDouble3, paramFloat1,
					paramFloat2);
	}

	private void doRenderShadowAndFire(net.minecraft.entity.Entity paramEntity, double paramDouble1,
			double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2) {
		if (beforeDoRenderShadowAndFireHooks != null)
			for (int i = beforeDoRenderShadowAndFireHooks.length - 1; i >= 0; i--)
				beforeDoRenderShadowAndFireHooks[i].beforeDoRenderShadowAndFire(paramEntity, paramDouble1, paramDouble2,
						paramDouble3, paramFloat1, paramFloat2);

		if (overrideDoRenderShadowAndFireHooks != null)
			overrideDoRenderShadowAndFireHooks[overrideDoRenderShadowAndFireHooks.length - 1].doRenderShadowAndFire(
					paramEntity, paramDouble1, paramDouble2, paramDouble3, paramFloat1, paramFloat2);
		else
			renderPlayer.localDoRenderShadowAndFire(paramEntity, paramDouble1, paramDouble2, paramDouble3, paramFloat1,
					paramFloat2);

		if (afterDoRenderShadowAndFireHooks != null)
			for (int i = 0; i < afterDoRenderShadowAndFireHooks.length; i++)
				afterDoRenderShadowAndFireHooks[i].afterDoRenderShadowAndFire(paramEntity, paramDouble1, paramDouble2,
						paramDouble3, paramFloat1, paramFloat2);
	...
	private static final Map<String, String[]> allBaseBeforeDoRenderShadowAndFireSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeDoRenderShadowAndFireInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideDoRenderShadowAndFireSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideDoRenderShadowAndFireInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterDoRenderShadowAndFireSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterDoRenderShadowAndFireInferiors = new Hashtable<String, String[]>(
			0);

	public static int getColorMultiplier(IRenderPlayerAPI target,
			net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat1, float paramFloat2) {
		int _result;
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private int getColorMultiplier(net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat1,
			float paramFloat2) {
		if (beforeGetColorMultiplierHooks != null)
			for (int i = beforeGetColorMultiplierHooks.length - 1; i >= 0; i--)
				beforeGetColorMultiplierHooks[i].beforeGetColorMultiplier(paramEntityLivingBase, paramFloat1,
						paramFloat2);

		int _result;
		if (overrideGetColorMultiplierHooks != null)
			_result = overrideGetColorMultiplierHooks[overrideGetColorMultiplierHooks.length - 1]
					.getColorMultiplier(paramEntityLivingBase, paramFloat1, paramFloat2);
		else
		...
		if (afterGetColorMultiplierHooks != null)
			for (int i = 0; i < afterGetColorMultiplierHooks.length; i++)
				afterGetColorMultiplierHooks[i].afterGetColorMultiplier(paramEntityLivingBase, paramFloat1,
						paramFloat2);
	...
	private static final Map<String, String[]> allBaseBeforeGetColorMultiplierSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeGetColorMultiplierInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetColorMultiplierSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetColorMultiplierInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetColorMultiplierSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetColorMultiplierInferiors = new Hashtable<String, String[]>(
			0);

	public static float getDeathMaxRotation(IRenderPlayerAPI target,
			net.minecraft.entity.EntityLivingBase paramEntityLivingBase) {
		float _result;
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private float getDeathMaxRotation(net.minecraft.entity.EntityLivingBase paramEntityLivingBase) {
		...
		if (overrideGetDeathMaxRotationHooks != null)
			_result = overrideGetDeathMaxRotationHooks[overrideGetDeathMaxRotationHooks.length - 1]
					.getDeathMaxRotation(paramEntityLivingBase);
		else
	...
	private static final Map<String, String[]> allBaseBeforeGetDeathMaxRotationSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeGetDeathMaxRotationInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetDeathMaxRotationSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetDeathMaxRotationInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetDeathMaxRotationSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetDeathMaxRotationInferiors = new Hashtable<String, String[]>(
			0);
	...
	private net.minecraft.client.gui.FontRenderer getFontRendererFromRenderManager() {
		...
		if (overrideGetFontRendererFromRenderManagerHooks != null)
			_result = overrideGetFontRendererFromRenderManagerHooks[overrideGetFontRendererFromRenderManagerHooks.length
					- 1].getFontRendererFromRenderManager();
		else
	...
	private static final Map<String, String[]> allBaseBeforeGetFontRendererFromRenderManagerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeGetFontRendererFromRenderManagerInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetFontRendererFromRenderManagerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetFontRendererFromRenderManagerInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetFontRendererFromRenderManagerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetFontRendererFromRenderManagerInferiors = new Hashtable<String, String[]>(
			0);

	public static net.minecraft.util.ResourceLocation getResourceLocationFromPlayer(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer) {
	...
	private net.minecraft.util.ResourceLocation getResourceLocationFromPlayer(
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer) {
		if (beforeGetResourceLocationFromPlayerHooks != null)
			for (int i = beforeGetResourceLocationFromPlayerHooks.length - 1; i >= 0; i--)
				beforeGetResourceLocationFromPlayerHooks[i]
						.beforeGetResourceLocationFromPlayer(paramAbstractClientPlayer);

		net.minecraft.util.ResourceLocation _result;
		if (overrideGetResourceLocationFromPlayerHooks != null)
			_result = overrideGetResourceLocationFromPlayerHooks[overrideGetResourceLocationFromPlayerHooks.length - 1]
					.getResourceLocationFromPlayer(paramAbstractClientPlayer);
		else
		...
		if (afterGetResourceLocationFromPlayerHooks != null)
			for (int i = 0; i < afterGetResourceLocationFromPlayerHooks.length; i++)
				afterGetResourceLocationFromPlayerHooks[i]
						.afterGetResourceLocationFromPlayer(paramAbstractClientPlayer);
	...
	private static final Map<String, String[]> allBaseBeforeGetResourceLocationFromPlayerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeGetResourceLocationFromPlayerInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetResourceLocationFromPlayerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetResourceLocationFromPlayerInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetResourceLocationFromPlayerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetResourceLocationFromPlayerInferiors = new Hashtable<String, String[]>(
			0);

	public static float handleRotationFloat(IRenderPlayerAPI target,
			net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat) {
		float _result;
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private float handleRotationFloat(net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat) {
		...
		if (overrideHandleRotationFloatHooks != null)
			_result = overrideHandleRotationFloatHooks[overrideHandleRotationFloatHooks.length - 1]
					.handleRotationFloat(paramEntityLivingBase, paramFloat);
		else
	...
	private static final Map<String, String[]> allBaseBeforeHandleRotationFloatSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeHandleRotationFloatInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideHandleRotationFloatSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideHandleRotationFloatInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterHandleRotationFloatSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterHandleRotationFloatInferiors = new Hashtable<String, String[]>(
			0);

	public static int inheritRenderPass(IRenderPlayerAPI target,
			net.minecraft.entity.EntityLivingBase paramEntityLivingBase, int paramInt, float paramFloat) {
		int _result;
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private int inheritRenderPass(net.minecraft.entity.EntityLivingBase paramEntityLivingBase, int paramInt,
			float paramFloat) {
		...
		if (overrideInheritRenderPassHooks != null)
			_result = overrideInheritRenderPassHooks[overrideInheritRenderPassHooks.length - 1]
					.inheritRenderPass(paramEntityLivingBase, paramInt, paramFloat);
		else
	...
	private static final Map<String, String[]> allBaseBeforeInheritRenderPassSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeInheritRenderPassInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideInheritRenderPassSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideInheritRenderPassInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterInheritRenderPassSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterInheritRenderPassInferiors = new Hashtable<String, String[]>(
			0);
	...
	private void loadTextureOfEntity(net.minecraft.entity.Entity paramEntity) {
		...
		if (overrideLoadTextureOfEntityHooks != null)
			overrideLoadTextureOfEntityHooks[overrideLoadTextureOfEntityHooks.length - 1]
					.loadTextureOfEntity(paramEntity);
		else
	...
	private static final Map<String, String[]> allBaseBeforeLoadTextureOfEntitySuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeLoadTextureOfEntityInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideLoadTextureOfEntitySuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideLoadTextureOfEntityInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterLoadTextureOfEntitySuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterLoadTextureOfEntityInferiors = new Hashtable<String, String[]>(
			0);

	public static void passSpecialRender(IRenderPlayerAPI target,
			net.minecraft.entity.EntityLivingBase paramEntityLivingBase, double paramDouble1, double paramDouble2,
			double paramDouble3) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void passSpecialRender(net.minecraft.entity.EntityLivingBase paramEntityLivingBase, double paramDouble1,
		...
		if (beforePassSpecialRenderHooks != null)
			for (int i = beforePassSpecialRenderHooks.length - 1; i >= 0; i--)
				beforePassSpecialRenderHooks[i].beforePassSpecialRender(paramEntityLivingBase, paramDouble1,
						paramDouble2, paramDouble3);

		if (overridePassSpecialRenderHooks != null)
			overridePassSpecialRenderHooks[overridePassSpecialRenderHooks.length - 1]
					.passSpecialRender(paramEntityLivingBase, paramDouble1, paramDouble2, paramDouble3);
		else
		...
		if (afterPassSpecialRenderHooks != null)
			for (int i = 0; i < afterPassSpecialRenderHooks.length; i++)
				afterPassSpecialRenderHooks[i].afterPassSpecialRender(paramEntityLivingBase, paramDouble1, paramDouble2,
						paramDouble3);
	...
	private static final Map<String, String[]> allBaseBeforePassSpecialRenderSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforePassSpecialRenderInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverridePassSpecialRenderSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverridePassSpecialRenderInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterPassSpecialRenderSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterPassSpecialRenderInferiors = new Hashtable<String, String[]>(
			0);
	...
	private boolean performStaticEntityRebuild() {
		...
		if (overridePerformStaticEntityRebuildHooks != null)
			_result = overridePerformStaticEntityRebuildHooks[overridePerformStaticEntityRebuildHooks.length - 1]
					.performStaticEntityRebuild();
		else
	...
	private static final Map<String, String[]> allBaseBeforePerformStaticEntityRebuildSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforePerformStaticEntityRebuildInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverridePerformStaticEntityRebuildSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverridePerformStaticEntityRebuildInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterPerformStaticEntityRebuildSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterPerformStaticEntityRebuildInferiors = new Hashtable<String, String[]>(
			0);

	public static void renderArrowsStuckInEntity(IRenderPlayerAPI target,
			net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void renderArrowsStuckInEntity(net.minecraft.entity.EntityLivingBase paramEntityLivingBase,
			float paramFloat) {
		if (beforeRenderArrowsStuckInEntityHooks != null)
			for (int i = beforeRenderArrowsStuckInEntityHooks.length - 1; i >= 0; i--)
				beforeRenderArrowsStuckInEntityHooks[i].beforeRenderArrowsStuckInEntity(paramEntityLivingBase,
						paramFloat);

		if (overrideRenderArrowsStuckInEntityHooks != null)
			overrideRenderArrowsStuckInEntityHooks[overrideRenderArrowsStuckInEntityHooks.length - 1]
					.renderArrowsStuckInEntity(paramEntityLivingBase, paramFloat);
		else
		...
		if (afterRenderArrowsStuckInEntityHooks != null)
			for (int i = 0; i < afterRenderArrowsStuckInEntityHooks.length; i++)
				afterRenderArrowsStuckInEntityHooks[i].afterRenderArrowsStuckInEntity(paramEntityLivingBase,
						paramFloat);
	...
	private static final Map<String, String[]> allBaseBeforeRenderArrowsStuckInEntitySuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderArrowsStuckInEntityInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderArrowsStuckInEntitySuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderArrowsStuckInEntityInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderArrowsStuckInEntitySuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderArrowsStuckInEntityInferiors = new Hashtable<String, String[]>(
			0);

	public static void renderFirstPersonArm(IRenderPlayerAPI target,
			net.minecraft.entity.player.EntityPlayer paramEntityPlayer) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void renderFirstPersonArm(net.minecraft.entity.player.EntityPlayer paramEntityPlayer) {
		...
		if (overrideRenderFirstPersonArmHooks != null)
			overrideRenderFirstPersonArmHooks[overrideRenderFirstPersonArmHooks.length - 1]
					.renderFirstPersonArm(paramEntityPlayer);
		else
	...
	private static final Map<String, String[]> allBaseBeforeRenderFirstPersonArmSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderFirstPersonArmInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderFirstPersonArmSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderFirstPersonArmInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderFirstPersonArmSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderFirstPersonArmInferiors = new Hashtable<String, String[]>(
			0);

	public static void renderLivingLabel(IRenderPlayerAPI target, net.minecraft.entity.Entity paramEntity,
			String paramString, double paramDouble1, double paramDouble2, double paramDouble3, int paramInt) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
		if (renderPlayerAPI != null && renderPlayerAPI.isRenderLivingLabelModded)
			renderPlayerAPI.renderLivingLabel(paramEntity, paramString, paramDouble1, paramDouble2, paramDouble3,
					paramInt);
		else
			target.localRenderLivingLabel(paramEntity, paramString, paramDouble1, paramDouble2, paramDouble3, paramInt);
	}

	private void renderLivingLabel(net.minecraft.entity.Entity paramEntity, String paramString, double paramDouble1,
			double paramDouble2, double paramDouble3, int paramInt) {
		if (beforeRenderLivingLabelHooks != null)
			for (int i = beforeRenderLivingLabelHooks.length - 1; i >= 0; i--)
				beforeRenderLivingLabelHooks[i].beforeRenderLivingLabel(paramEntity, paramString, paramDouble1,
						paramDouble2, paramDouble3, paramInt);

		if (overrideRenderLivingLabelHooks != null)
			overrideRenderLivingLabelHooks[overrideRenderLivingLabelHooks.length - 1].renderLivingLabel(paramEntity,
					paramString, paramDouble1, paramDouble2, paramDouble3, paramInt);
		else
			renderPlayer.localRenderLivingLabel(paramEntity, paramString, paramDouble1, paramDouble2, paramDouble3,
					paramInt);

		if (afterRenderLivingLabelHooks != null)
			for (int i = 0; i < afterRenderLivingLabelHooks.length; i++)
				afterRenderLivingLabelHooks[i].afterRenderLivingLabel(paramEntity, paramString, paramDouble1,
						paramDouble2, paramDouble3, paramInt);
	...
	private static final Map<String, String[]> allBaseBeforeRenderLivingLabelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderLivingLabelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderLivingLabelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderLivingLabelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderLivingLabelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderLivingLabelInferiors = new Hashtable<String, String[]>(
			0);

	public static void renderModel(IRenderPlayerAPI target, net.minecraft.entity.EntityLivingBase paramEntityLivingBase,
		...
		if (renderPlayerAPI != null && renderPlayerAPI.isRenderModelModded)
			renderPlayerAPI.renderModel(paramEntityLivingBase, paramFloat1, paramFloat2, paramFloat3, paramFloat4,
					paramFloat5, paramFloat6);
		else
			target.localRenderModel(paramEntityLivingBase, paramFloat1, paramFloat2, paramFloat3, paramFloat4,
					paramFloat5, paramFloat6);
	}

	private void renderModel(net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat1,
			float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6) {
		if (beforeRenderModelHooks != null)
			for (int i = beforeRenderModelHooks.length - 1; i >= 0; i--)
				beforeRenderModelHooks[i].beforeRenderModel(paramEntityLivingBase, paramFloat1, paramFloat2,
						paramFloat3, paramFloat4, paramFloat5, paramFloat6);

		if (overrideRenderModelHooks != null)
			overrideRenderModelHooks[overrideRenderModelHooks.length - 1].renderModel(paramEntityLivingBase,
					paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6);
		else
			renderPlayer.localRenderModel(paramEntityLivingBase, paramFloat1, paramFloat2, paramFloat3, paramFloat4,
					paramFloat5, paramFloat6);

		if (afterRenderModelHooks != null)
			for (int i = 0; i < afterRenderModelHooks.length; i++)
				afterRenderModelHooks[i].afterRenderModel(paramEntityLivingBase, paramFloat1, paramFloat2, paramFloat3,
	...
	public static void renderPlayer(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, double paramDouble1,
			double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
		if (renderPlayerAPI != null && renderPlayerAPI.isRenderPlayerModded)
			renderPlayerAPI.renderPlayer(paramAbstractClientPlayer, paramDouble1, paramDouble2, paramDouble3,
					paramFloat1, paramFloat2);
		else
			target.localRenderPlayer(paramAbstractClientPlayer, paramDouble1, paramDouble2, paramDouble3, paramFloat1,
					paramFloat2);
	}

	private void renderPlayer(net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer,
			double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2) {
		if (beforeRenderPlayerHooks != null)
			for (int i = beforeRenderPlayerHooks.length - 1; i >= 0; i--)
				beforeRenderPlayerHooks[i].beforeRenderPlayer(paramAbstractClientPlayer, paramDouble1, paramDouble2,
						paramDouble3, paramFloat1, paramFloat2);

		if (overrideRenderPlayerHooks != null)
			overrideRenderPlayerHooks[overrideRenderPlayerHooks.length - 1].renderPlayer(paramAbstractClientPlayer,
					paramDouble1, paramDouble2, paramDouble3, paramFloat1, paramFloat2);
		else
			renderPlayer.localRenderPlayer(paramAbstractClientPlayer, paramDouble1, paramDouble2, paramDouble3,
					paramFloat1, paramFloat2);

		if (afterRenderPlayerHooks != null)
			for (int i = 0; i < afterRenderPlayerHooks.length; i++)
				afterRenderPlayerHooks[i].afterRenderPlayer(paramAbstractClientPlayer, paramDouble1, paramDouble2,
						paramDouble3, paramFloat1, paramFloat2);
	...
	private static final Map<String, String[]> allBaseOverrideRenderPlayerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderPlayerInferiors = new Hashtable<String, String[]>(
			0);
	...
	public static void renderPlayerNameAndScoreLabel(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, double paramDouble1,
			double paramDouble2, double paramDouble3, String paramString, float paramFloat, double paramDouble4) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
		if (renderPlayerAPI != null && renderPlayerAPI.isRenderPlayerNameAndScoreLabelModded)
			renderPlayerAPI.renderPlayerNameAndScoreLabel(paramAbstractClientPlayer, paramDouble1, paramDouble2,
					paramDouble3, paramString, paramFloat, paramDouble4);
		else
			target.localRenderPlayerNameAndScoreLabel(paramAbstractClientPlayer, paramDouble1, paramDouble2,
					paramDouble3, paramString, paramFloat, paramDouble4);
	}

	private void renderPlayerNameAndScoreLabel(
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, double paramDouble1,
			double paramDouble2, double paramDouble3, String paramString, float paramFloat, double paramDouble4) {
		if (beforeRenderPlayerNameAndScoreLabelHooks != null)
			for (int i = beforeRenderPlayerNameAndScoreLabelHooks.length - 1; i >= 0; i--)
				beforeRenderPlayerNameAndScoreLabelHooks[i].beforeRenderPlayerNameAndScoreLabel(
						paramAbstractClientPlayer, paramDouble1, paramDouble2, paramDouble3, paramString, paramFloat,
						paramDouble4);

		if (overrideRenderPlayerNameAndScoreLabelHooks != null)
			overrideRenderPlayerNameAndScoreLabelHooks[overrideRenderPlayerNameAndScoreLabelHooks.length - 1]
					.renderPlayerNameAndScoreLabel(paramAbstractClientPlayer, paramDouble1, paramDouble2, paramDouble3,
							paramString, paramFloat, paramDouble4);
		else
			renderPlayer.localRenderPlayerNameAndScoreLabel(paramAbstractClientPlayer, paramDouble1, paramDouble2,
					paramDouble3, paramString, paramFloat, paramDouble4);

		if (afterRenderPlayerNameAndScoreLabelHooks != null)
			for (int i = 0; i < afterRenderPlayerNameAndScoreLabelHooks.length; i++)
				afterRenderPlayerNameAndScoreLabelHooks[i].afterRenderPlayerNameAndScoreLabel(paramAbstractClientPlayer,
						paramDouble1, paramDouble2, paramDouble3, paramString, paramFloat, paramDouble4);
	...
	private static final Map<String, String[]> allBaseBeforeRenderPlayerNameAndScoreLabelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderPlayerNameAndScoreLabelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderPlayerNameAndScoreLabelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderPlayerNameAndScoreLabelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderPlayerNameAndScoreLabelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderPlayerNameAndScoreLabelInferiors = new Hashtable<String, String[]>(
			0);

	public static void renderPlayerScale(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, float paramFloat) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void renderPlayerScale(net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer,
			float paramFloat) {
		...
		if (overrideRenderPlayerScaleHooks != null)
			overrideRenderPlayerScaleHooks[overrideRenderPlayerScaleHooks.length - 1]
					.renderPlayerScale(paramAbstractClientPlayer, paramFloat);
		else
	...
	private static final Map<String, String[]> allBaseBeforeRenderPlayerScaleSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderPlayerScaleInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderPlayerScaleSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderPlayerScaleInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderPlayerScaleSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderPlayerScaleInferiors = new Hashtable<String, String[]>(
			0);

	public static void renderPlayerSleep(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, double paramDouble1,
			double paramDouble2, double paramDouble3) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void renderPlayerSleep(net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer,
		...
		if (beforeRenderPlayerSleepHooks != null)
			for (int i = beforeRenderPlayerSleepHooks.length - 1; i >= 0; i--)
				beforeRenderPlayerSleepHooks[i].beforeRenderPlayerSleep(paramAbstractClientPlayer, paramDouble1,
						paramDouble2, paramDouble3);

		if (overrideRenderPlayerSleepHooks != null)
			overrideRenderPlayerSleepHooks[overrideRenderPlayerSleepHooks.length - 1]
					.renderPlayerSleep(paramAbstractClientPlayer, paramDouble1, paramDouble2, paramDouble3);
		else
		...
		if (afterRenderPlayerSleepHooks != null)
			for (int i = 0; i < afterRenderPlayerSleepHooks.length; i++)
				afterRenderPlayerSleepHooks[i].afterRenderPlayerSleep(paramAbstractClientPlayer, paramDouble1,
						paramDouble2, paramDouble3);
	...
	private static final Map<String, String[]> allBaseBeforeRenderPlayerSleepSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderPlayerSleepInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderPlayerSleepSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderPlayerSleepInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderPlayerSleepSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderPlayerSleepInferiors = new Hashtable<String, String[]>(
			0);

	public static void renderSpecials(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, float paramFloat) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void renderSpecials(net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer,
			float paramFloat) {
		...
		if (overrideRenderSpecialsHooks != null)
			overrideRenderSpecialsHooks[overrideRenderSpecialsHooks.length - 1]
					.renderSpecials(paramAbstractClientPlayer, paramFloat);
		else
	...
	private static final Map<String, String[]> allBaseBeforeRenderSpecialsSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderSpecialsInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderSpecialsSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderSpecialsInferiors = new Hashtable<String, String[]>(
			0);
	...
	public static float renderSwingProgress(IRenderPlayerAPI target,
			net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat) {
		float _result;
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private float renderSwingProgress(net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat) {
		...
		if (overrideRenderSwingProgressHooks != null)
			_result = overrideRenderSwingProgressHooks[overrideRenderSwingProgressHooks.length - 1]
					.renderSwingProgress(paramEntityLivingBase, paramFloat);
		else
	...
	private static final Map<String, String[]> allBaseBeforeRenderSwingProgressSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeRenderSwingProgressInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderSwingProgressSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRenderSwingProgressInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderSwingProgressSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterRenderSwingProgressInferiors = new Hashtable<String, String[]>(
			0);

	public static void rotatePlayer(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, float paramFloat1,
	...
	private void rotatePlayer(net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer,
		...
		if (beforeRotatePlayerHooks != null)
			for (int i = beforeRotatePlayerHooks.length - 1; i >= 0; i--)
				beforeRotatePlayerHooks[i].beforeRotatePlayer(paramAbstractClientPlayer, paramFloat1, paramFloat2,
						paramFloat3);

		if (overrideRotatePlayerHooks != null)
			overrideRotatePlayerHooks[overrideRotatePlayerHooks.length - 1].rotatePlayer(paramAbstractClientPlayer,
		...
		if (afterRotatePlayerHooks != null)
			for (int i = 0; i < afterRotatePlayerHooks.length; i++)
				afterRotatePlayerHooks[i].afterRotatePlayer(paramAbstractClientPlayer, paramFloat1, paramFloat2,
						paramFloat3);
	...
	private static final Map<String, String[]> allBaseOverrideRotatePlayerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideRotatePlayerInferiors = new Hashtable<String, String[]>(
			0);
	...
	public static int setArmorModel(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, int paramInt,
			float paramFloat) {
		int _result;
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private int setArmorModel(net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, int paramInt,
			float paramFloat) {
		...
		if (overrideSetArmorModelHooks != null)
			_result = overrideSetArmorModelHooks[overrideSetArmorModelHooks.length - 1]
					.setArmorModel(paramAbstractClientPlayer, paramInt, paramFloat);
		else
	...
	private static final Map<String, String[]> allBaseOverrideSetArmorModelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetArmorModelInferiors = new Hashtable<String, String[]>(
			0);
	...
	public static void setPassArmorModel(IRenderPlayerAPI target,
			net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer, int paramInt,
			float paramFloat) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void setPassArmorModel(net.minecraft.client.entity.AbstractClientPlayer paramAbstractClientPlayer,
			int paramInt, float paramFloat) {
		if (beforeSetPassArmorModelHooks != null)
			for (int i = beforeSetPassArmorModelHooks.length - 1; i >= 0; i--)
				beforeSetPassArmorModelHooks[i].beforeSetPassArmorModel(paramAbstractClientPlayer, paramInt,
						paramFloat);

		if (overrideSetPassArmorModelHooks != null)
			overrideSetPassArmorModelHooks[overrideSetPassArmorModelHooks.length - 1]
					.setPassArmorModel(paramAbstractClientPlayer, paramInt, paramFloat);
		else
	...
	private static final Map<String, String[]> allBaseBeforeSetPassArmorModelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeSetPassArmorModelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetPassArmorModelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetPassArmorModelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetPassArmorModelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetPassArmorModelInferiors = new Hashtable<String, String[]>(
			0);

	public static void setRenderManager(IRenderPlayerAPI target,
			net.minecraft.client.renderer.entity.RenderManager paramRenderManager) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void setRenderManager(net.minecraft.client.renderer.entity.RenderManager paramRenderManager) {
		...
		if (overrideSetRenderManagerHooks != null)
			overrideSetRenderManagerHooks[overrideSetRenderManagerHooks.length - 1]
					.setRenderManager(paramRenderManager);
		else
	...
	private static final Map<String, String[]> allBaseBeforeSetRenderManagerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeSetRenderManagerInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetRenderManagerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetRenderManagerInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetRenderManagerSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetRenderManagerInferiors = new Hashtable<String, String[]>(
			0);

	public static void setRenderPassModel(IRenderPlayerAPI target,
			net.minecraft.client.model.ModelBase paramModelBase) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
	...
	private void setRenderPassModel(net.minecraft.client.model.ModelBase paramModelBase) {
		...
		if (overrideSetRenderPassModelHooks != null)
			overrideSetRenderPassModelHooks[overrideSetRenderPassModelHooks.length - 1]
					.setRenderPassModel(paramModelBase);
		else
	...
	private static final Map<String, String[]> allBaseBeforeSetRenderPassModelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeSetRenderPassModelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetRenderPassModelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetRenderPassModelInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetRenderPassModelSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetRenderPassModelInferiors = new Hashtable<String, String[]>(
			0);

	public static void updateIcons(IRenderPlayerAPI target,
			net.minecraft.client.renderer.texture.IIconRegister paramIIconRegister) {
		RenderPlayerAPI renderPlayerAPI = target.getRenderPlayerAPI();
