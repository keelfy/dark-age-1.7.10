...
public class GuiScript extends GuiNPCInterface implements IGuiData, GuiYesNoCallback, ICustomScrollListener, IJTextAreaListener {	
	...
	public void initGui() {
		...
		if(showScript){
			...
			addTextField(new GuiNpcTextArea(2, this, this.fontRendererObj, guiLeft + 74, guiTop + 4, 239, 208, container == null?"":container.script));
			...
			addTextField(new GuiNpcTextArea(2, this, this.fontRendererObj, guiLeft + 4, guiTop + 26, 226, 186, getConsoleText()));
