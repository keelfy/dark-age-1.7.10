...
public class RenderNPCHumanMale extends RenderNPCInterface
{
	...
	protected void renderSpecials(EntityNPCInterface npc, float f)
	{
		...
		{
			/*		if(itemstackPlate != null && itemstackPlate.getItem() == WitcherItemLoader.ДоспехБригадыИмперра) {

			GL11.glPushMatrix();
			modelBipedMain.bipedBody.postRender(0.0625F);
			GL11.glTranslatef(0F, 0F, 0F);
			GL11.glScalef(1F, 1F, 1F);
			RenderManager.instance.renderEngine.bindTexture(this.NilfGaardTexture);
			this.NilfBody.render(0.0625F);
			GL11.glPopMatrix();

			GL11.glPushMatrix();
			RenderManager.instance.renderEngine.bindTexture(this.NilfGaardTexture);
			modelBipedMain.bipedLeftArm.postRender(0.0625F);
			GL11.glTranslatef(-0.31F, -0.14F, 0.0F);
	        GL11.glScalef(1F, 1F, 1F);
			this.NLefthand.render(0.0625F);
			GL11.glPopMatrix();
