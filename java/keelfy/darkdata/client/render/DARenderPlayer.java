...
public class DARenderPlayer extends ModelPlayerBase {

	public DARenderPlayer(final ModelPlayerAPI modelPlayerAPI) {
		super(modelPlayerAPI);
	}

	public static final void register() {
		ModelPlayerAPI.register("DAModelPlayer", DARenderPlayer.class);
	}
	...
	public void setRotationAngles(final float p_78087_1_, final float p_78087_2_, final float p_78087_3_,
		...
		if (KUtils.PROTECT_CLIENT) {
			...
			super.modelPlayer.bipedRightArm.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F + 3.1415927F) * 2.0F
					* p_78087_2_ * 0.5F;
			super.modelPlayer.bipedLeftArm.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F) * 2.0F * p_78087_2_
					* 0.5F;
			...
			super.modelPlayer.bipedLeftLeg.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F + 3.1415927F) * 1.4F
					* p_78087_2_;
			...
			if (super.modelPlayer.heldItemLeft != 0) {
				super.modelPlayer.bipedLeftArm.rotateAngleX = super.modelPlayer.bipedLeftArm.rotateAngleX * 0.5F
						- 0.31415927F * super.modelPlayer.heldItemLeft;
			}

			if (super.modelPlayer.heldItemRight != 0) {
				super.modelPlayer.bipedRightArm.rotateAngleX = super.modelPlayer.bipedRightArm.rotateAngleX * 0.5F
						- 0.31415927F * super.modelPlayer.heldItemRight;
			}
			...
			if (super.modelPlayer.onGround > -9990.0F) {
				...
				super.modelPlayer.bipedBody.rotateAngleY = MathHelper
						.sin(MathHelper.sqrt_float(f6) * (float) Math.PI * 2.0F) * 0.2F;
				super.modelPlayer.bipedRightArm.rotationPointZ = MathHelper
						.sin(super.modelPlayer.bipedBody.rotateAngleY) * 5.0F;
				super.modelPlayer.bipedRightArm.rotationPointX = -MathHelper
						.cos(super.modelPlayer.bipedBody.rotateAngleY) * 5.0F;
				super.modelPlayer.bipedLeftArm.rotationPointZ = -MathHelper
						.sin(super.modelPlayer.bipedBody.rotateAngleY) * 5.0F;
				super.modelPlayer.bipedLeftArm.rotationPointX = MathHelper.cos(super.modelPlayer.bipedBody.rotateAngleY)
						* 5.0F;
				...
				float f8 = MathHelper.sin(super.modelPlayer.onGround * 3.1415927F)
						* -(super.modelPlayer.bipedHead.rotateAngleX - 0.7F) * 0.75F;
			...
			if (super.modelPlayer.aimedBow) {
				...
				f7 = 0.0F;
				super.modelPlayer.bipedRightArm.rotateAngleZ = 0.0F;
				super.modelPlayer.bipedRightArm.rotateAngleY = -(0.1F - f6 * 0.6F)
						+ super.modelPlayer.bipedHead.rotateAngleY;
	...
	@Override
	public void afterSetRotationAngles(final float paramFloat1, final float paramFloat2, final float paramFloat3,
			final float paramFloat4, final float paramFloat5, final float paramFloat6, final Entity paramEntity) {
		if (KUtils.PROTECT_CLIENT) {
