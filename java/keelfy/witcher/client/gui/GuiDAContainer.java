...
public abstract class GuiDAContainer extends GuiContainer {
    ...
    public GuiDAContainer(Container container) {
    	super(container);
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
    	if(!DAUtil.SERVER || DAUtil.DEBUG_MODE) {
	        ...
	        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
	        {
	            ...
	            if (this.isMouseOverSlot(slot, p_73863_1_, p_73863_2_))
	            {
	                this.theSlot = slot;
	                GL11.glDisable(GL11.GL_LIGHTING);
	                GL11.glDisable(GL11.GL_DEPTH_TEST);
	                ...
	                if(!(mc.currentScreen instanceof GuiDAInventory) && !(mc.thePlayer.capabilities.isCreativeMode))
