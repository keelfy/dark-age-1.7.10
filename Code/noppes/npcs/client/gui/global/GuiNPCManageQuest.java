...
public class GuiNPCManageQuest extends GuiNPCInterface2 implements IScrollData, ISubGuiListener, GuiSelectionListener,
	...
	public void initGui() {
		super.initGui();
		this.addButton(new GuiNpcButton(0, guiLeft + 358, guiTop + 8, 58, 20,
	...
	private void dialogGuiInit() {
		...
		addTextField(
				new GuiNpcTextField(1, this, this.fontRendererObj, guiLeft + 36, guiTop + 3, 140, 20, quest.title));
		...
		this.addButton(new GuiNpcButton(8, guiLeft + 110, guiTop + 109, 70, 20, new String[] { "gui.no", "gui.yes",
				"quest.mcdaily", "quest.mcweekly", "quest.rldaily", "quest.rlweekly" }, quest.repeat.ordinal()));

		this.addButton(new GuiNpcButton(9, guiLeft + 4, guiTop + 131, 90, 20,
				new String[] { "quest.npc", "quest.instant" }, quest.completion.ordinal()));

		if (quest.completerNpc.isEmpty())
			quest.completerNpc = npc.display.name;

		this.addTextField(new GuiNpcTextField(2, this, this.fontRendererObj, guiLeft + 96, guiTop + 131, 114, 20,
				quest.completerNpc));
	...
	private void categoryGuiInit() {
		addTextField(
				new GuiNpcTextField(0, this, this.fontRendererObj, guiLeft + 8, guiTop + 8, 160, 16, category.title));
	}
