package keelfy.witcher.entity.player;

import keelfy.api.network.PacketDispatcher;
import keelfy.witcher.entity.player.DAPlayerUtil.Property;
import keelfy.witcher.entity.player.DAPlayerUtil.Property.PropertyType;
import keelfy.witcher.entity.player.weight.PlayerWeight;
...
import keelfy.witcher.item.Armor.ArmorType;
...
public class DAPlayer implements IExtendedEntityProperties {
	...
	public void saveNBTData(NBTTagCompound compound) {
		if(DAUtil.SERVER || DAUtil.DEBUG_MODE) {
			...
			properties.setInteger("Money", money);
	...
	public void loadNBTData(NBTTagCompound compound) {
		...
		money = properties.getInteger("Money");
