...
public abstract class DAGuiContainer extends GuiContainer {
    ...
    public DAGuiContainer(Container container) {
    	super(container);
    	...
    	if(KeelfyUtils.isClientSide()) {
	        ...
	        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
	        {
	            ...
	            if (this.isMouseOverSlot(slot, p_73863_1_, p_73863_2_))
	            {
	                ...
	                if(!(mc.currentScreen instanceof DAGuiInventory) && !(mc.thePlayer.capabilities.isCreativeMode))
