...
public class RenderDAPlayer extends RenderPlayerBase {
	...
	public static final ResourceLocation textureKven = Texture.get(WCT.PARTICLE, "kven");
	...
	public static final ResourceLocation TalgarT = Texture.get(WCT.ARMOR, "Talgar/Talgar");
	public static final ResourceLocation TalgarSignT = Texture.get(WCT.ARMOR, "Talgar/TalgarSign");
	public static final WitcherTopornikPants WitcherTopornikPants = new WitcherTopornikPants();
	public static final ResourceLocation WitcherTopornikPantsT = Texture.get(WCT.ARMOR, "Pants/TopornikPants");
	public static final WitcherPathfinderLegs WitcherPathfinderLegs = new WitcherPathfinderLegs();
	public static final ResourceLocation WitcherPathfinderPantsT = Texture.get(WCT.ARMOR, "Pants/PathfinderLegs");
	public static final WitcherLuriskyPants WitcherLuriskyPants = new WitcherLuriskyPants();
	public static final ResourceLocation WitcherLuriskyPantsT = Texture.get(WCT.ARMOR, "Pants/LuriskyPants");
	public static final ResourceLocation CidarisCombezT = Texture.get(WCT.ARMOR, "Cidaris/CidarisCombez");
	...
	public static final ResourceLocation BelhavenaBrigantineT = Texture.get(WCT.ARMOR,
			"BelhavenaBrigantine/BelhavenaBrigantine");
	public static final CidarisLeg CidarisLeg = new CidarisLeg();
	public static final ResourceLocation CidarisT = Texture.get(WCT.ARMOR, "Cidaris/Cidaris");
	...
	public static final ResourceLocation WitchunterArmorT = Texture.get(WCT.ARMOR, "WitchunterArmor/WitchunterArmorT");
	...
	public static final ResourceLocation HindarsfjallHeavyArmorT = Texture.get(WCT.ARMOR,
	...
	public static final ResourceLocation BearSchoolT = Texture.get(WCT.ARMOR, "bearSchool/Armor");
	public static final ResourceLocation BearSchoolBootT = Texture.get(WCT.ARMOR, "bearSchool/Boot");
	public static final ResourceLocation BearSchoolSkirtT = Texture.get(WCT.ARMOR, "bearSchool/Skirt");
	public static final ResourceLocation BearSchoolT2 = Texture.get(WCT.ARMOR, "bearSchool/2/Armor");
	public static final ResourceLocation BearSchoolSkirtT2 = Texture.get(WCT.ARMOR, "bearSchool/2/Skirt");
	...
	public static final ResourceLocation CatPantsT = Texture.get(WCT.ARMOR, "catSchool/Pants");
	public static final ResourceLocation CatSchoolArmorT = Texture.get(WCT.ARMOR, "catSchool/Armor");
	...
	public static final ResourceLocation GriffinArmorT = Texture.get(WCT.ARMOR, "griffinSchool/GriffinArmor");
	public static final ResourceLocation GriffinPantsT = Texture.get(WCT.ARMOR, "griffinSchool/Pants");
	public static final ResourceLocation GriffinBootsT = Texture.get(WCT.ARMOR, "griffinSchool/Boot");
	...
	public static final ResourceLocation KaerMorhenArmorT = Texture.get(WCT.ARMOR, "KaerMorhen/Armor");
	public static final ResourceLocation KaerMorhenArmorHandT = Texture.get(WCT.ARMOR, "KaerMorhen/Hands");
	public static final ResourceLocation KaerMorhenArmorPantsT = Texture.get(WCT.ARMOR, "KaerMorhen/Pants");
	public static final ResourceLocation KaerMorhenArmorBootsT = Texture.get(WCT.ARMOR, "KaerMorhen/Boots");
	...
	public static final ResourceLocation WolfT = Texture.get(WCT.ARMOR, "wolfSchool/WolfSchool");
	public static final ResourceLocation WolfBootT = Texture.get(WCT.ARMOR, "wolfSchool/WolfSchoolBoot");
	...
	public static final ResourceLocation RedanianHalebardistArmorT = Texture.get(WCT.ARMOR, "RedanianHalebardistArmor/Armor");
	...
	public static final ResourceLocation NilfgaardArmorT = Texture.get(WCT.ARMOR, "Nilfgaard/Armor");
	public static final ResourceLocation NilfgaardArmorLegT = Texture.get(WCT.ARMOR, "Nilfgaard/Leg");
	public static final ResourceLocation NilfgaardArmorBootT = Texture.get(WCT.ARMOR, "Nilfgaard/Boot");
	...
	public static final ResourceLocation MagDeithraArmorT = Texture.get(WCT.ARMOR, "MagDeithraArmor/Armor");
	public static final ResourceLocation ViperArmorT = Texture.get(WCT.ARMOR, "viperSchool/Armor");
	public static final ResourceLocation ViperArmorHandT = Texture.get(WCT.ARMOR, "viperSchool/Hands");
	public static final ResourceLocation ViperArmorPantsT = Texture.get(WCT.ARMOR, "viperSchool/Pants");
	public static final ResourceLocation ViperArmorBootsT = Texture.get(WCT.ARMOR, "viperSchool/Boots");
	...
	public static final ResourceLocation ShirtT = Texture.get(WCT.ARMOR, "Shirt/WitcherShirt");
	public static final IModelCustom CatMedialion = Model.get(WCM.MEDALION, "CatMedallion");
	public static final ResourceLocation CatMedialionT = Texture.get(WCT.MEDALION, "CatMedallion");
	public static final IModelCustom WolfMedialion = Model.get(WCM.MEDALION, "WolfMedallion");
	public static final ResourceLocation WolfMedialionT = Texture.get(WCT.MEDALION, "WolfMedallion");
	public static final IModelCustom GriffinMedialion = Model.get(WCM.MEDALION, "GriffinMedallion");
	public static final ResourceLocation GriffinMedialionT = Texture.get(WCT.ARMOR, "school/Griffin/1/texlow");
	public static final IModelCustom BearMedialion = Model.get(WCM.MEDALION, "BearMedallion");
	public static final ResourceLocation BearMedialionT = Texture.get(WCT.ARMOR, "school/Bear/1/texlow");

	public static final ResourceLocation skinHuman = Texture.get(WCT.SKIN, "Human");
	public static final ResourceLocation skinWitcher = Texture.get(WCT.SKIN, "Witcher");
