...
import keelfy.darkage.handlers.client.FontHandler.CustomFont;
import keelfytools.KeelfyUtils;
import net.minecraft.client.renderer.texture.DynamicTexture;

@SideOnly(Side.CLIENT)
public class RenderCustomFont extends CustomFont {
    ...
    public RenderCustomFont(Font font, boolean antiAlias, boolean fractionalMetrics) {
