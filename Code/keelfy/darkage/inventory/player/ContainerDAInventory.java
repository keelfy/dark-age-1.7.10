...
public class ContainerDAInventory extends Container {
	...
	public ContainerDAInventory(EntityPlayer player, DAInventory inventoryCustom) {
		...
		this.addSlotToContainer(new SlotSword(inventoryPlayer, 1, 210, 52, SwordType.STEEL));
		this.addSlotToContainer(new SlotSword(inventoryPlayer, 2, 240, 52, SwordType.SILVER));
