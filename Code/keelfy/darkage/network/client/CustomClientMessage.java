...
public class CustomClientMessage extends AbstractClientMessage<CustomClientMessage> {
	...
	private Object[] args;
	private int length;
	private PacketForClient packetType;
	
	public CustomClientMessage() {}
	
	public CustomClientMessage(PacketForClient packetType, Object[] args) {
	...
	protected void read(PacketBuffer buffer) throws IOException {
		if(!DAUtil.SERVER || DAUtil.DEBUG_MODE) {
			packetType = PacketForClient.values() [buffer.readInt()];
	 ...
	 * @created 5 июн. 2017 г.
	 */
	public static enum PacketForClient {
		REPAIRREQUEST, SYNCEFFETCS, SYNCPLAYER, KILLPLAYER;
	}
}
