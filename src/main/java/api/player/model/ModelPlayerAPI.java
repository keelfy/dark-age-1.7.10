...
public final class ModelPlayerAPI {
	...
	private static void register(Class<?> baseClass, String id, ModelPlayerBaseSorting baseSorting) {
		if (!isCreated) {
			try {
				...
				if (mandatory.getReturnType() != ModelPlayerBase.class)
					throw new NoSuchMethodException(ModelPlayerBase.class.getName() + KString.SPACE
							+ api.player.model.ModelPlayer.class.getName() + ".getModelPlayerBase("
				...
				for (int i = 0; i < errorMessageParts.length; i++)
					errorMessageParts[i] = MessageFormat.format(errorMessageParts[i], baseModelPlayerClassName,
		...
		if (baseSorting != null) {
			...
			addSorting(id, allBaseOverrideGetRandomModelBoxSuperiors,
					baseSorting.getOverrideGetRandomModelBoxSuperiors());
			addSorting(id, allBaseOverrideGetRandomModelBoxInferiors,
					baseSorting.getOverrideGetRandomModelBoxInferiors());
			...
			addSorting(id, allBaseOverrideGetTextureOffsetSuperiors,
					baseSorting.getOverrideGetTextureOffsetSuperiors());
			addSorting(id, allBaseOverrideGetTextureOffsetInferiors,
					baseSorting.getOverrideGetTextureOffsetInferiors());
			...
			addSorting(id, allBaseBeforeSetLivingAnimationsSuperiors,
					baseSorting.getBeforeSetLivingAnimationsSuperiors());
			addSorting(id, allBaseBeforeSetLivingAnimationsInferiors,
					baseSorting.getBeforeSetLivingAnimationsInferiors());
			addSorting(id, allBaseOverrideSetLivingAnimationsSuperiors,
					baseSorting.getOverrideSetLivingAnimationsSuperiors());
			addSorting(id, allBaseOverrideSetLivingAnimationsInferiors,
					baseSorting.getOverrideSetLivingAnimationsInferiors());
			addSorting(id, allBaseAfterSetLivingAnimationsSuperiors,
					baseSorting.getAfterSetLivingAnimationsSuperiors());
			addSorting(id, allBaseAfterSetLivingAnimationsInferiors,
					baseSorting.getAfterSetLivingAnimationsInferiors());
			...
			addSorting(id, allBaseOverrideSetRotationAnglesSuperiors,
					baseSorting.getOverrideSetRotationAnglesSuperiors());
			addSorting(id, allBaseOverrideSetRotationAnglesInferiors,
					baseSorting.getOverrideSetRotationAnglesInferiors());
			...
			addSorting(id, allBaseOverrideSetTextureOffsetSuperiors,
					baseSorting.getOverrideSetTextureOffsetSuperiors());
			addSorting(id, allBaseOverrideSetTextureOffsetInferiors,
					baseSorting.getOverrideSetTextureOffsetInferiors());
		...
		addMethod(id, baseClass, beforeRenderHookTypes, "beforeRender", net.minecraft.entity.Entity.class, float.class,
				float.class, float.class, float.class, float.class, float.class);
		addMethod(id, baseClass, overrideRenderHookTypes, "render", net.minecraft.entity.Entity.class, float.class,
				float.class, float.class, float.class, float.class, float.class);
		addMethod(id, baseClass, afterRenderHookTypes, "afterRender", net.minecraft.entity.Entity.class, float.class,
				float.class, float.class, float.class, float.class, float.class);
		...
		addMethod(id, baseClass, beforeSetLivingAnimationsHookTypes, "beforeSetLivingAnimations",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class, float.class);
		addMethod(id, baseClass, overrideSetLivingAnimationsHookTypes, "setLivingAnimations",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class, float.class);
		addMethod(id, baseClass, afterSetLivingAnimationsHookTypes, "afterSetLivingAnimations",
				net.minecraft.entity.EntityLivingBase.class, float.class, float.class, float.class);

		addMethod(id, baseClass, beforeSetRotationAnglesHookTypes, "beforeSetRotationAngles", float.class, float.class,
				float.class, float.class, float.class, float.class, net.minecraft.entity.Entity.class);
		addMethod(id, baseClass, overrideSetRotationAnglesHookTypes, "setRotationAngles", float.class, float.class,
				float.class, float.class, float.class, float.class, net.minecraft.entity.Entity.class);
		addMethod(id, baseClass, afterSetRotationAnglesHookTypes, "afterSetRotationAngles", float.class, float.class,
				float.class, float.class, float.class, float.class, net.minecraft.entity.Entity.class);

		addMethod(id, baseClass, beforeSetTextureOffsetHookTypes, "beforeSetTextureOffset", String.class, int.class,
				int.class);
		addMethod(id, baseClass, overrideSetTextureOffsetHookTypes, "setTextureOffset", String.class, int.class,
				int.class);
		addMethod(id, baseClass, afterSetTextureOffsetHookTypes, "afterSetTextureOffset", String.class, int.class,
				int.class);
	...
	private static void initialize() {
		...
		sortBases(beforeGetRandomModelBoxHookTypes, allBaseBeforeGetRandomModelBoxSuperiors,
				allBaseBeforeGetRandomModelBoxInferiors, "beforeGetRandomModelBox");
		sortBases(overrideGetRandomModelBoxHookTypes, allBaseOverrideGetRandomModelBoxSuperiors,
				allBaseOverrideGetRandomModelBoxInferiors, "overrideGetRandomModelBox");
		sortBases(afterGetRandomModelBoxHookTypes, allBaseAfterGetRandomModelBoxSuperiors,
				allBaseAfterGetRandomModelBoxInferiors, "afterGetRandomModelBox");

		sortBases(beforeGetTextureOffsetHookTypes, allBaseBeforeGetTextureOffsetSuperiors,
				allBaseBeforeGetTextureOffsetInferiors, "beforeGetTextureOffset");
		sortBases(overrideGetTextureOffsetHookTypes, allBaseOverrideGetTextureOffsetSuperiors,
				allBaseOverrideGetTextureOffsetInferiors, "overrideGetTextureOffset");
		sortBases(afterGetTextureOffsetHookTypes, allBaseAfterGetTextureOffsetSuperiors,
				allBaseAfterGetTextureOffsetInferiors, "afterGetTextureOffset");

		sortBases(beforeRenderHookTypes, allBaseBeforeRenderSuperiors, allBaseBeforeRenderInferiors, "beforeRender");
		sortBases(overrideRenderHookTypes, allBaseOverrideRenderSuperiors, allBaseOverrideRenderInferiors,
				"overrideRender");
		sortBases(afterRenderHookTypes, allBaseAfterRenderSuperiors, allBaseAfterRenderInferiors, "afterRender");

		sortBases(beforeRenderCloakHookTypes, allBaseBeforeRenderCloakSuperiors, allBaseBeforeRenderCloakInferiors,
				"beforeRenderCloak");
		sortBases(overrideRenderCloakHookTypes, allBaseOverrideRenderCloakSuperiors,
				allBaseOverrideRenderCloakInferiors, "overrideRenderCloak");
		sortBases(afterRenderCloakHookTypes, allBaseAfterRenderCloakSuperiors, allBaseAfterRenderCloakInferiors,
				"afterRenderCloak");

		sortBases(beforeRenderEarsHookTypes, allBaseBeforeRenderEarsSuperiors, allBaseBeforeRenderEarsInferiors,
				"beforeRenderEars");
		sortBases(overrideRenderEarsHookTypes, allBaseOverrideRenderEarsSuperiors, allBaseOverrideRenderEarsInferiors,
				"overrideRenderEars");
		sortBases(afterRenderEarsHookTypes, allBaseAfterRenderEarsSuperiors, allBaseAfterRenderEarsInferiors,
				"afterRenderEars");

		sortBases(beforeSetLivingAnimationsHookTypes, allBaseBeforeSetLivingAnimationsSuperiors,
				allBaseBeforeSetLivingAnimationsInferiors, "beforeSetLivingAnimations");
		sortBases(overrideSetLivingAnimationsHookTypes, allBaseOverrideSetLivingAnimationsSuperiors,
				allBaseOverrideSetLivingAnimationsInferiors, "overrideSetLivingAnimations");
		sortBases(afterSetLivingAnimationsHookTypes, allBaseAfterSetLivingAnimationsSuperiors,
				allBaseAfterSetLivingAnimationsInferiors, "afterSetLivingAnimations");

		sortBases(beforeSetRotationAnglesHookTypes, allBaseBeforeSetRotationAnglesSuperiors,
				allBaseBeforeSetRotationAnglesInferiors, "beforeSetRotationAngles");
		sortBases(overrideSetRotationAnglesHookTypes, allBaseOverrideSetRotationAnglesSuperiors,
				allBaseOverrideSetRotationAnglesInferiors, "overrideSetRotationAngles");
		sortBases(afterSetRotationAnglesHookTypes, allBaseAfterSetRotationAnglesSuperiors,
				allBaseAfterSetRotationAnglesInferiors, "afterSetRotationAngles");

		sortBases(beforeSetTextureOffsetHookTypes, allBaseBeforeSetTextureOffsetSuperiors,
				allBaseBeforeSetTextureOffsetInferiors, "beforeSetTextureOffset");
		sortBases(overrideSetTextureOffsetHookTypes, allBaseOverrideSetTextureOffsetSuperiors,
				allBaseOverrideSetTextureOffsetInferiors, "overrideSetTextureOffset");
		sortBases(afterSetTextureOffsetHookTypes, allBaseAfterSetTextureOffsetSuperiors,
				allBaseAfterSetTextureOffsetInferiors, "afterSetTextureOffset");
	...
	private ModelPlayerBase createModelPlayerBase(String id) {
		...
		try {
			...
			throw new RuntimeException(
					"Exception while creating a ModelPlayerBase of type '" + contructor.getDeclaringClass() + "'", e);
		}
		return base;
	}
	...
	private void updateModelPlayerBases() {
		...
		isGetRandomModelBoxModded = beforeGetRandomModelBoxHooks != null || overrideGetRandomModelBoxHooks != null
		...
		isGetTextureOffsetModded = beforeGetTextureOffsetHooks != null || overrideGetTextureOffsetHooks != null
		...
		isRenderModded = beforeRenderHooks != null || overrideRenderHooks != null || afterRenderHooks != null;
		...
		isRenderCloakModded = beforeRenderCloakHooks != null || overrideRenderCloakHooks != null
		...
		isRenderEarsModded = beforeRenderEarsHooks != null || overrideRenderEarsHooks != null
		...
		isSetLivingAnimationsModded = beforeSetLivingAnimationsHooks != null || overrideSetLivingAnimationsHooks != null
		...
		isSetRotationAnglesModded = beforeSetRotationAnglesHooks != null || overrideSetRotationAnglesHooks != null
		...
		isSetTextureOffsetModded = beforeSetTextureOffsetHooks != null || overrideSetTextureOffsetHooks != null
	...
	public static net.minecraft.client.model.ModelRenderer getRandomModelBox(IModelPlayerAPI target,
			java.util.Random paramRandom) {
	...
	private net.minecraft.client.model.ModelRenderer getRandomModelBox(java.util.Random paramRandom) {
		...
		if (overrideGetRandomModelBoxHooks != null)
			_result = overrideGetRandomModelBoxHooks[overrideGetRandomModelBoxHooks.length - 1]
					.getRandomModelBox(paramRandom);
		else
	...
	private static final Map<String, String[]> allBaseBeforeGetRandomModelBoxSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeGetRandomModelBoxInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetRandomModelBoxSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetRandomModelBoxInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetRandomModelBoxSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetRandomModelBoxInferiors = new Hashtable<String, String[]>(
			0);

	public static net.minecraft.client.model.TextureOffset getTextureOffset(IModelPlayerAPI target,
			String paramString) {
	...
	private net.minecraft.client.model.TextureOffset getTextureOffset(String paramString) {
		...
		if (overrideGetTextureOffsetHooks != null)
			_result = overrideGetTextureOffsetHooks[overrideGetTextureOffsetHooks.length - 1]
					.getTextureOffset(paramString);
		else
	...
	private static final Map<String, String[]> allBaseBeforeGetTextureOffsetSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeGetTextureOffsetInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetTextureOffsetSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideGetTextureOffsetInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetTextureOffsetSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterGetTextureOffsetInferiors = new Hashtable<String, String[]>(
			0);

	public static void render(IModelPlayerAPI target, net.minecraft.entity.Entity paramEntity, float paramFloat1,
		...
		if (modelPlayerAPI != null && modelPlayerAPI.isRenderModded)
			modelPlayerAPI.render(paramEntity, paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5,
					paramFloat6);
		else
			target.localRender(paramEntity, paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5,
					paramFloat6);
	}

	private void render(net.minecraft.entity.Entity paramEntity, float paramFloat1, float paramFloat2,
		...
		if (beforeRenderHooks != null)
			for (int i = beforeRenderHooks.length - 1; i >= 0; i--)
				beforeRenderHooks[i].beforeRender(paramEntity, paramFloat1, paramFloat2, paramFloat3, paramFloat4,
						paramFloat5, paramFloat6);

		if (overrideRenderHooks != null)
			overrideRenderHooks[overrideRenderHooks.length - 1].render(paramEntity, paramFloat1, paramFloat2,
					paramFloat3, paramFloat4, paramFloat5, paramFloat6);
		else
			modelPlayer.localRender(paramEntity, paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5,
					paramFloat6);

		if (afterRenderHooks != null)
			for (int i = 0; i < afterRenderHooks.length; i++)
				afterRenderHooks[i].afterRender(paramEntity, paramFloat1, paramFloat2, paramFloat3, paramFloat4,
						paramFloat5, paramFloat6);
	...
	public static void setLivingAnimations(IModelPlayerAPI target,
	...
	private void setLivingAnimations(net.minecraft.entity.EntityLivingBase paramEntityLivingBase, float paramFloat1,
		...
		if (beforeSetLivingAnimationsHooks != null)
			for (int i = beforeSetLivingAnimationsHooks.length - 1; i >= 0; i--)
				beforeSetLivingAnimationsHooks[i].beforeSetLivingAnimations(paramEntityLivingBase, paramFloat1,
						paramFloat2, paramFloat3);

		if (overrideSetLivingAnimationsHooks != null)
			overrideSetLivingAnimationsHooks[overrideSetLivingAnimationsHooks.length - 1]
					.setLivingAnimations(paramEntityLivingBase, paramFloat1, paramFloat2, paramFloat3);
		else
		...
		if (afterSetLivingAnimationsHooks != null)
			for (int i = 0; i < afterSetLivingAnimationsHooks.length; i++)
				afterSetLivingAnimationsHooks[i].afterSetLivingAnimations(paramEntityLivingBase, paramFloat1,
						paramFloat2, paramFloat3);
	...
	private static final Map<String, String[]> allBaseBeforeSetLivingAnimationsSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeSetLivingAnimationsInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetLivingAnimationsSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetLivingAnimationsInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetLivingAnimationsSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetLivingAnimationsInferiors = new Hashtable<String, String[]>(
			0);

	public static void setRotationAngles(IModelPlayerAPI target, float paramFloat1, float paramFloat2,
			float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6,
			net.minecraft.entity.Entity paramEntity) {
		ModelPlayerAPI modelPlayerAPI = target.getModelPlayerAPI();
		if (modelPlayerAPI != null && modelPlayerAPI.isSetRotationAnglesModded)
			modelPlayerAPI.setRotationAngles(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5,
					paramFloat6, paramEntity);
		else
			target.localSetRotationAngles(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6,
					paramEntity);
	}

	private void setRotationAngles(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4,
			float paramFloat5, float paramFloat6, net.minecraft.entity.Entity paramEntity) {
		if (beforeSetRotationAnglesHooks != null)
			for (int i = beforeSetRotationAnglesHooks.length - 1; i >= 0; i--)
				beforeSetRotationAnglesHooks[i].beforeSetRotationAngles(paramFloat1, paramFloat2, paramFloat3,
						paramFloat4, paramFloat5, paramFloat6, paramEntity);

		if (overrideSetRotationAnglesHooks != null)
			overrideSetRotationAnglesHooks[overrideSetRotationAnglesHooks.length - 1].setRotationAngles(paramFloat1,
					paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6, paramEntity);
		else
			modelPlayer.localSetRotationAngles(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5,
					paramFloat6, paramEntity);

		if (afterSetRotationAnglesHooks != null)
			for (int i = 0; i < afterSetRotationAnglesHooks.length; i++)
				afterSetRotationAnglesHooks[i].afterSetRotationAngles(paramFloat1, paramFloat2, paramFloat3,
						paramFloat4, paramFloat5, paramFloat6, paramEntity);
	...
	private static final Map<String, String[]> allBaseBeforeSetRotationAnglesSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeSetRotationAnglesInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetRotationAnglesSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetRotationAnglesInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetRotationAnglesSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetRotationAnglesInferiors = new Hashtable<String, String[]>(
			0);
	...
	private void setTextureOffset(String paramString, int paramInt1, int paramInt2) {
		...
		if (overrideSetTextureOffsetHooks != null)
			overrideSetTextureOffsetHooks[overrideSetTextureOffsetHooks.length - 1].setTextureOffset(paramString,
					paramInt1, paramInt2);
		else
	...
	private static final Map<String, String[]> allBaseBeforeSetTextureOffsetSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseBeforeSetTextureOffsetInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetTextureOffsetSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseOverrideSetTextureOffsetInferiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetTextureOffsetSuperiors = new Hashtable<String, String[]>(
			0);
	private static final Map<String, String[]> allBaseAfterSetTextureOffsetInferiors = new Hashtable<String, String[]>(
			0);
