...
public class QuestController {
	...
	public void load() {
		...
		try {
			File file = new File(CustomNpcs.getSaveDirectory(true), "quests.dat");
			if (file.exists()) {
				loadCategoriesOld(file);
				file.delete();
				file = new File(CustomNpcs.getSaveDirectory(true), "quests.dat_old");
				if (file.exists()) {
					file.delete();
				}
				return;
	...
	private File getDir() {
		return new File(CustomNpcs.getSaveDirectory(true), "quests");
	}
